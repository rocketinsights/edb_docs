...
If you create an index on a partitioned table, the `CREATE INDEX`
command does propagate indexes to the table’s subpartitions.
...
<span class="title-ref">ALTER INDEX \<alter_index\>_</span>,
