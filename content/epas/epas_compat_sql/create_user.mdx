...
`CREATE USER` adds a new user to an Advanced Server database cluster.
...
> The user’s password. The password can be changed later using `ALTER
> USER`.
...
<span class="title-ref">DROP USER \<drop_user\>_</span>
