.. _configuring_advanced_server:

************************************
`Configuring Advanced Server`:index:
************************************
...
.. figure:: images/accessing_configuration_files.png
    :alt: Accessing the configuration files through the Windows system menu
    :align: center
...
.. toctree::
   ...
   modifying_the_postgresql_conf_file
   modifying_the_pg_hba_conf_file
   setting_advanced_server_environment_variables
   connecting_to_advanced_server_with_psql
   connecting_to_advanced_server_with_the_pgadmin_4_client
