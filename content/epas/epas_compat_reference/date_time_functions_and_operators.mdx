...
operators `(+, -)`. For formatting functions, refer to
<span class="title-ref">Section - IMMUTABLE TO_CHAR(TIMESTAMP, format)
Function \<immutable_to_char_function\>_</span>. You should be
familiar

with the background information on date/time data types from Section

<span class="title-ref">Section - Date/Time Types
\<date_time_types\>_</span>.
