...
metaTitle: Comparison Operators
...
of type `BOOLEAN;` expressions like `1 < 2 < 3` are not valid (because
...
whether two unknown values are equal.) This behavior conforms to the SQL
standard.
