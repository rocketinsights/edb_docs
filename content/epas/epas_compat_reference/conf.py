...
latex_documents = [
    (master_doc, 'Database_Compatibility_for_Oracle_Developers_Reference_Guide.tex', 'EDB Postgres™ Advanced Server',
     'Database Compatibility for Oracle Developers Reference Guide', 'manual'),
]
