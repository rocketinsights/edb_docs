...
<span class="title-ref">Declaring Host Variables
\<declaring_host_variables\>_</span> section.
...
about data types, see the <span class="title-ref">Supported C Data Types
\<supported_c_data_types\>_</span> section.
