...
Refer to
[displayResultSet](executing_query_with_unknown_number_of_variables)
...
value expressions, please refer to [Declaring Host
Variables](declaring_host_variables) section.
