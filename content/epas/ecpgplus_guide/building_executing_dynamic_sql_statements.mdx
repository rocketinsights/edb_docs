...
The application calls the handle_error() function whenever it
encounters a SQL error. The handle_error() function prints the content
...
See <span class="title-ref">SQLDA Structure
\<sqlda_structure\>_</span> section for a complete description of the
SQLDA structure.
