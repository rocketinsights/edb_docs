...
Advanced Server home directory.
  ...
  - **shared_preload_libraries.** Add `$libdir/sqlprotect` to the list
    of libraries.
  - **edb_sql_protect.enabled.** Controls whether or not `SQL/Protect`
...
<span class="title-ref">Setting the Protection Level
\<setting_the_protection_level\>_</span> for more information.

  - **edb_sql_protect.max_protected_roles.** Sets the maximum number
    of roles that can be protected. If this parameter is omitted, the
    default setting is `64`.
  - **edb_sql_protect.max_protected_relations.** Sets the maximum
...
> reserved during database server startup.
  ...
  - **edb_sql_protect.max_queries_to_save.** Sets the maximum
...
<span class="title-ref">Learn Mode \<learn_mode\>_</span> section.
...
<span class="title-ref">edb_sql_protect_stats</span><span class="title-ref">,
...
</span><span class="title-ref">edb_sql_protect_stats</span>\`.
