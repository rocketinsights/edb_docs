.. _common_maintenance_operations:
...
you use the :ref:`drop_stats function <drop_stats>`.  The offending queries for a role 
that has been removed are not deleted until you use the :ref:`drop_queries function <drop_queries>`.
