...
metaTitle: Installing Language Pack
...
<div id="invoking_the_graphical_installer">
...
![*The Language Pack Welcome
Window*](images/the_language_pack_welcome_window.png)

Click `Next` to continue.

![*The Ready to Install dialog*](images/the_ready_to_install_dialog.png)

The `Ready to Install` window displays the Language Pack installation
directory:
...
![*The Language Pack Setup Complete
dialog*](images/the_language_pack_setup_complete_dialog.png)
...
Window*](images/the_stackbuilder_plus_window.png)
...
control, and check the box to the left of `EDB Language Pack`; click
`Next` to continue.
...
For details about using the graphical installer, see [Invoking the
Graphical Installer](invoking_the_graphical_installer).
...
Windows, use the Windows `Services` applet to restart the Advanced
...
To simplify setting the value of `PATH` or `LD_LIBRARY_PATH`, you can
create environment variables that identify the installation location:
