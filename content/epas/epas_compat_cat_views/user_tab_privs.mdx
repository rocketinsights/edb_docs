...
metaTitle: USER_TAB_PRIVS
metaDescription: description
---

The `USER_TAB_PRIVS` view provides a listing of the object privileges
for which a current user is either an object owner, grantor, or grantee.
