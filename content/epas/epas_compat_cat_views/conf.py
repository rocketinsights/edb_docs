...
project = 'EDB Postgres™ Advanced Server'
...
latex_documents = [
    (master_doc, 'Database_Compatibility_for_Oracle_Developers_Catalog_Views_Guide.tex', 'EDB Postgres™ Advanced Server',
     'Database Compatibility for \\and Oracle Developers Catalog Views Guide', 'manual'),
]
