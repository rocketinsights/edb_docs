...
>     behavior.
>   - Specify `TRUE` to instruct the server to disable to any jobs that
>     use the specified schedule before dropping the schedule. Any
>     running jobs will be allowed to complete before the schedule is
>     dropped.
