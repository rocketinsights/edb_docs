---
title: OPEN_CURSOR
metaTitle: OPEN_CURSOR
metaDescription: description
---

The `OPEN_CURSOR` function creates a new cursor. A cursor must be used
to parse and execute any dynamic SQL statement. Once a cursor has been
