...
=======================
`DBMS_SCHEDULER`:index:
=======================

The ``DBMS_SCHEDULER`` package provides a way to create and manage
Oracle-styled jobs, programs and job schedules. The ``DBMS_SCHEDULER``
...
.. table::
   ...
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | CREATE_SCHEDULE(                                                                                                                                                                     | n/a           | Use the CREATE_SCHEDULE procedure to create a schedule.                                                                            |
   | <schedule_name>, <start_date>, <repeat_interval>, <end_date>, <comments>)                                                                                                            |               |                                                                                                                                    |
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | DEFINE_PROGRAM_ARGUMENT(                                                                                                                                                             | n/a           | Use the first form of the DEFINE_PROGRAM_ARGUMENT procedure to define a program argument that has a default value.                 |
   | <program_name>, <argument_position>, <argument_name>, <argument_type>, <default_value>, <Mout_argument>)                                                                             |               |                                                                                                                                    |
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | DEFINE_PROGRAM_ARGUMENT(                                                                                                                                                             | n/a           | Use the first form of the DEFINE_PROGRAM_ARGUMENT procedure to define a program argument that does not have a default value.       |
   ...
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | DROP_PROGRAM_ARGUMENT(                                                                                                                                                               | n/a           | Use the first form of DROP_PROGRAM_ARGUMENT to drop a program argument by specifying the argument position.                        |
   | <program_name>, <argument_position>)                                                                                                                                                 |               |                                                                                                                                    |
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | DROP_PROGRAM_ARGUMENT(                                                                                                                                                               | n/a           | Use the second form of DROP_PROGRAM_ARGUMENT to drop a program argument by specifying the argument name.                           |
   ...
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | EVALUATE_CALENDAR_STRING(                                                                                                                                                            | n/a           | Use EVALUATE_CALENDAR_STRING to review the execution date described by a user-defined calendar schedule.                           |
   ...
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | SET_JOB_ARGUMENT_VALUE(                                                                                                                                                              | n/a           | Use the first form of SET_JOB_ARGUMENT value to set the value of a job argument described by the argument's position.              |
   | <job_name>, <argument_position>, <argument_value>)                                                                                                                                   |               |                                                                                                                                    |
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+
   | SET_JOB_ARGUMENT_VALUE(                                                                                                                                                              | n/a           | Use the second form of SET_JOB_ARGUMENT value to set the value of a job argument described by the argument's name.                 |
   | <job_name>, <argument_name>, <argument_value>)                                                                                                                                       |               |                                                                                                                                    |
   +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------+

Advanced Server's implementation of ``DBMS_SCHEDULER`` is a partial
...
The ``DBMS_SCHEDULER`` package is dependent on the pgAgent service; you
must have a pgAgent service installed and running on your server before
using ``DBMS_SCHEDULER``.

Before using ``DBMS_SCHEDULER``, a database superuser must create the
catalog tables in which the ``DBMS_SCHEDULER`` programs, schedules and jobs
are stored. Use the ``psql`` client to connect to the database, and invoke
the command:
...
Note that after creating the ``DBMS_SCHEDULER`` tables, only a superuser
will be able to perform a dump or reload of the database.

.. toctree::
   :maxdepth: 6

   using_calendar_syntax_to_specify_a_repeating_interval
   create_job
   create_program
   create_schedule
   define_program_argument
   dbms_scheduler_disable
   drop_job
   drop_program
   drop_program_argument
   drop_schedule
   dbms_scheduler_enable
