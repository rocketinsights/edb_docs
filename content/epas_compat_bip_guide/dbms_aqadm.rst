...
queue table. Procedures in the DBMS_AQADM package create and manage
message queues and queue tables. Use the DBMS_AQ package to add
...
for the DBMS_AQ package with SQL commands. Please see the *Database
...
The DBMS_AQADM package provides procedures that allow you to create and
...
Advanced Server's implementation of ``DBMS_AQADM`` is a partial
...
.. tabularcolumns:: |\Y{0.45}|\Y{0.2}|\Y{0.35}|
