---
title: REMOVE_PIPE
metaTitle: REMOVE_PIPE
metaDescription: description
---

The `REMOVE_PIPE` function deletes an explicit private or explicit
public pipe.

`<status> INTEGER REMOVE_PIPE(<pipename> VARCHAR2)`

Use the `REMOVE_PIPE` function to delete explicitly created pipes –
i.e., pipes created with the `CREATE_PIPE` function.
