---
title: CREATE_PIPE
metaTitle: CREATE_PIPE
metaDescription: description
---

The `CREATE_PIPE` function creates an explicit public pipe or an
explicit private pipe with a specified name.
...
> Status code returned by the operation. 0 indicates successful
> creation.
