...
project = 'Database Compatibility for Oracle® Developers Built-in Packages Guide'
...
latex_documents = [
    (master_doc, 'EDB_AS_dbcompat_bip.tex', 'Database Compability for Oracle® Developers Built-in Package Guide',
     'EDB Postgres™ Advanced Server 12', 'manual'),
]

latex_logo = 'images/edblogo.png'
