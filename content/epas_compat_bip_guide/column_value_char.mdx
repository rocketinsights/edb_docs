...
> Position within the cursor of the returned data. The first value in
> the cursor is position 1.

`<value>`

> Variable of data type `CHAR` receiving the data returned in the cursor
> by a prior fetch call.
