...
> `<commit_semantics>` is set to `STOP_ON_FIRST_ERROR`, instructing the
> server to stop when it encounters an error. Any programs or jobs that
> were successfully disabled prior to the error will be committed to
> disk.
> 
