...
Use procedures in the ``DBMS_MVIEW`` package to manage and refresh
materialized views and their dependencies. Advanced Server provides
support for the following ``DBMS_MVIEW`` procedures:
...
Advanced Server's implementation of ``DBMS_MVIEW`` is a partial
