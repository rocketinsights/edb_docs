...
![*The Create trace Periodic job options tab*](images/trace_periodic_job_options.png)
...
![*The SQL Profiler tab, displaying the trace results*](images/sql_profiler_trace_result.png)
