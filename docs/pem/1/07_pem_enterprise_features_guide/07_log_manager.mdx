...
![*The Log Manager Server selection dialog*](images/log_manager_server_selection.png)
...
![*The Log Manager Log configuration dialog*](images/log_manager_log_configuration.png)
...
![*The Log Manager When to Log dialog*](images/log_manager_when_to_log.png)
...
![*The Log Manager What to Log dialog*](images/log_manager_what_to_log.png)
...
![*The Schedule Logging Changes dialog*](images/log_manager_schedule_logging.png)
