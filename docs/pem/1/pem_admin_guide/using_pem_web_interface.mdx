...
metaTitle: Using the PEM Web Interface
...
![*The PEM Login page*](images/pem_login.png)
...
authenticate yourself with the PEM server:
  ...
  - Provide the password associated with the user in the `Password`
    field.
...
![*The Global Overview dashboard, displayed in the
client*](images/pem_global_overview.png)
...
The `Object` menu is context-sensitive. Use the `Object` menu to access
...
![*The Dashboards menu*](images/pem_dashboard_menu.png)
...
![*The Tools menu*](images/pem_tools_menu.png)
...
Use the options on the `Help` menu to access the online help documents
or to review information about the PEM installation:
...
![*The PEM Client chart control
icons*](images/client_chart_control_icons.png)
...
<tbody>
<tr class="odd">
<td><img src="/images/lginformation.png" style="width:0.20833in;height:0.20833in" alt="icon6" /></td>
<td><blockquote>
<p>View information about the chart, graph, or table.</p>
</blockquote></td>
</tr>
<tr class="even">
<td><img src="/images/lgrefresh.png" style="width:0.20833in;height:0.20833in" alt="icon1" /></td>
<td><blockquote>
<p>Refresh the content of a chart, graph or table.</p>
</blockquote></td>
</tr>
<tr class="odd">
<td><img src="/images/lgpersonalize.png" style="width:0.20833in;height:0.20833in" alt="icon3" /></td>
<td><blockquote>
<p>Personalize the chart, graph, or table settings for the current user.</p>
</blockquote></td>
</tr>
<tr class="even">
<td><img src="/images/lgdownload.png" style="width:0.20833in;height:0.20833in" alt="icon4" /></td>
<td><blockquote>
<p>Download an image of the chart or graph.</p>
</blockquote></td>
</tr>
<tr class="odd">
<td><img src="/images/lginformation.png" style="width:0.20833in;height:0.20833in" alt="icon5" /></td>
<td><blockquote>
<p>View the legends that are used in the chart, graph, or table.</p>
</blockquote></td>
</tr>
<tr class="even">
<td><img src="/images/lgfullscreen.png" style="width:0.20833in;height:0.20833in" alt="icon2" /></td>
<td><blockquote>
<p>Expand the chart or graph to full-screen.</p>
</blockquote></td>
</tr>
</tbody>
</table>
...
PEM contains built-in help that provides assistance in using the tool.
To access the online help for PEM, select Online Help from the Help
