...
metaTitle: The PEM Server - PEM Agent Connection Management Mechanism
...
![*Connecting to the PEM database without
pgBouncer*](images/pem_database_without_pgbouncer.png)
