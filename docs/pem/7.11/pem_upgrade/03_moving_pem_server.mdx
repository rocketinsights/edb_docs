...
<figure><img src="images/move_pem_server_drop_schema.png" class="align-center" alt="Dropping the pem schema" /><figcaption aria-hidden="true"><em>Dropping the pem schema</em></figcaption></figure>
...
<figure><img src="images/move_pem_server_restore_backup.png" class="align-center" alt="Restoring a backup script" /><figcaption aria-hidden="true"><em>Restoring a backup script</em></figcaption></figure>
...
<figure><img src="images/move_server_windows_permission.png" class="align-center" alt="The Permissions tab" /><figcaption aria-hidden="true"><em>The Permissions tab</em></figcaption></figure>
...
<figure><img src="images/move_pem_server_agent_cfg.png" class="align-center" alt="The agent.cfg file" /><figcaption aria-hidden="true"><em>The agent.cfg file</em></figcaption></figure>
...
<figure><img src="images/move_pem_server_windows_registry.png" class="align-center" alt="The Windows Registry Editor" /><figcaption aria-hidden="true"><em>The Windows Registry Editor</em></figcaption></figure>
...
<figure><img src="images/move_pem_server_windows_registry_edit.png" class="align-center" alt="The Windows Registry Editor" /><figcaption aria-hidden="true"><em>The Windows Registry Editor</em></figcaption></figure>
...
<figure><img src="images/move_pem_server_restart_agent.png" class="align-center" alt="Restarting the PEM Agent&#39;s service" /><figcaption aria-hidden="true"><em>Restarting the PEM Agent's service</em></figcaption></figure>
