...
<figure><img src="images/log_manager_welcome.png" class="align-center" alt="The Log Manager welcome dialog" /><figcaption aria-hidden="true"><em>The Log Manager welcome dialog</em></figcaption></figure>

Click `Next` to continue to the `Server selection` dialog.

<figure><img src="images/log_manager_server_selection.png" class="align-center" alt="The Log Manager Server selection dialog" /><figcaption aria-hidden="true"><em>The Log Manager Server selection dialog</em></figcaption></figure>
...
-   Use the `Directory name` field to specify the directory to which log files will be written. The directory will reside beneath the pg\_log directory under the installation directory of the monitored server.

\- Use the `Log File Name` field to specify a format for the log file  
name. If set to `DEFAULT`, the format is `enterprisedb-%Y-%m-%d_%H%M%S`, where:
...
<figure><img src="images/log_manager_when_to_log.png" class="align-center" alt="The Log Manager When to Log dialog" /><figcaption aria-hidden="true"><em>The Log Manager When to Log dialog</em></figcaption></figure>
...
<figure><img src="images/log_manager_what_to_log.png" class="align-center" alt="The Log Manager What to Log dialog" /><figcaption aria-hidden="true"><em>The Log Manager What to Log dialog</em></figcaption></figure>
...
-   Set the `Lock Waits` switch to Yes to instruct the server to write a log entry for any session that waits longer than the time specified in the deadlock\_timeout parameter to acquire a lock. This is useful when trying to determine if lock waits are the cause of poor performance.
...
Use the `Prefix string` field to specify a printf-style string that is written at the beginning of each log file entry. For information about the options supported, please see the log\_line\_prefix documentation (in the Postgres core documentation), available at:
...
<figure><img src="images/log_manager_schedule_logging.png" class="align-center" alt="The Schedule Logging Changes dialog" /><figcaption aria-hidden="true"><em>The Schedule Logging Changes dialog</em></figcaption></figure>
...
<figure><img src="images/server_log_analysis_dashboard.png" class="align-center" alt="The Server Log Analysis dashboard" /><figcaption aria-hidden="true"><em>The Server Log Analysis dashboard</em></figcaption></figure>
...
<figure><img src="images/defining_server_log_filter.png" class="align-center" alt="Defining a Server Log filter" /><figcaption aria-hidden="true"><em>Defining a Server Log filter</em></figcaption></figure>
...
<figure><img src="images/plae_welcome.png" class="align-center" alt="The Log Analysis Expert Welcome dialog" /><figcaption aria-hidden="true"><em>The Log Analysis Expert Welcome dialog</em></figcaption></figure>
...
<figure><img src="images/plae_analyzer.png" class="align-center" alt="The Analyzer selection dialog" /><figcaption aria-hidden="true"><em>The Analyzer selection dialog</em></figcaption></figure>
...
<figure><img src="images/plae_server_selection.png" class="align-center" alt="The Server selection dialog" /><figcaption aria-hidden="true"><em>The Server selection dialog</em></figcaption></figure>
...
<figure><img src="images/plae_report_options.png" class="align-center" alt="The Report options dialog" /><figcaption aria-hidden="true"><em>The Report options dialog</em></figcaption></figure>
...
<figure><img src="images/plae_report_destination.png" class="align-center" alt="The Report destination dialog" /><figcaption aria-hidden="true"><em>The Report destination dialog</em></figcaption></figure>
...
<figure><img src="images/PLAE_report.png" class="align-center" alt="The Postgres Log Analysis Expert Report" /><figcaption aria-hidden="true"><em>The Postgres Log Analysis Expert Report</em></figcaption></figure>
