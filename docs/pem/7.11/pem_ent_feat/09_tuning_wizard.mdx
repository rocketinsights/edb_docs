...
<figure><img src="images/tuning_wizard_welcome.png" class="align-center" alt="The Tuning Wizard Welcome dialog" /><figcaption aria-hidden="true"><em>The Tuning Wizard Welcome dialog</em></figcaption></figure>

Click `Next` to continue to the server selection dialog.

<figure><img src="images/tuning_wizard_select_servers.png" class="align-center" alt="The Select Servers dialog" /><figcaption aria-hidden="true"><em>The Select Servers dialog</em></figcaption></figure>
...
<figure><img src="images/tuning_wizard_configuration.png" class="align-center" alt="The Configuration dialog" /><figcaption aria-hidden="true"><em>The Configuration dialog</em></figcaption></figure>
...
<figure><img src="images/tuning_wizard_tuning_changes_summary.png" class="align-center" alt="The Tuning Changes Summary dialo" /><figcaption aria-hidden="true"><em>The Tuning Changes Summary dialo</em></figcaption></figure>
...
<figure><img src="images/tuning_wizard_schedule_or_run.png" class="align-center" alt="The Schedule or Run? dialog" /><figcaption aria-hidden="true"><em>The Schedule or Run? dialog</em></figcaption></figure>
...
<figure><img src="images/tuning_wizard_schedule_or_run_1.png" class="align-center" alt="The Schedule or Run? dialog" /><figcaption aria-hidden="true"><em>The Schedule or Run? dialog</em></figcaption></figure>
...
<figure><img src="images/tuning_wizard_report.png" class="align-center" alt="The Tuning Wizard report" /><figcaption aria-hidden="true"><em>The Tuning Wizard report</em></figcaption></figure>
...
<figure><img src="images/change_postgresql.png" class="align-center" alt="Confirming a change in the postgresql.conf file" /><figcaption aria-hidden="true"><em>Confirming a change in the postgresql.conf file</em></figcaption></figure>

You can also confirm a parameter value by querying the server. For example, to confirm the value of the shared\_buffers parameter, open a SQL command line using either the Query Tool (accessed through the Tools menu) or the psql client, and issue the command:
