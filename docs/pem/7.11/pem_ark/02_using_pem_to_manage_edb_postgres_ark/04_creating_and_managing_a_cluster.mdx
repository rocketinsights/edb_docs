...
<figure><img src="../images/cluster_type_selection_dialog.png" class="align-center" alt="The Cluster type selection dialog" /><figcaption aria-hidden="true"><em>The Cluster type selection dialog</em></figcaption></figure>
...
<figure><img src="../images/cluster_details_dialog.png" class="align-center" alt="The Cluster details dialog" /><figcaption aria-hidden="true"><em>The Cluster details dialog</em></figcaption></figure>
...
<figure><img src="../images/cluster_security_information_dialog.png" class="align-center" alt="The Cluster security information dialog" /><figcaption aria-hidden="true"><em>The Cluster security information dialog</em></figcaption></figure>
...
<figure><img src="../images/cluster_scaling_options_n_available_roles.png" class="align-center" alt="The Cluster Scaling options and available roles dialog" /><figcaption aria-hidden="true"><em>The Cluster Scaling options and available roles dialog</em></figcaption></figure>
...
<figure><img src="../images/availability_zone_subnet_details.png" class="align-center" alt="The Availability zone and subnet details dialog" /><figcaption aria-hidden="true"><em>The Availability zone and subnet details dialog</em></figcaption></figure>
...
<figure><img src="../images/backup_retention_details.png" class="align-center" alt="The Backup retention details dialog" /><figcaption aria-hidden="true"><em>The Backup retention details dialog</em></figcaption></figure>
...
<figure><img src="../images/clusters_list_properties_tab.png" class="align-center" alt="The clusters list on the Properties tab" /><figcaption aria-hidden="true"><em>The clusters list on the Properties tab</em></figcaption></figure>
...
<figure><img src="../images/cluster_dashboard_tab.png" class="align-center" alt="The Cluster Dashboard tab" /><figcaption aria-hidden="true"><em>The Cluster Dashboard tab</em></figcaption></figure>
...
<figure><img src="../images/cluster_properties_tab.png" class="align-center" alt="The Cluster Properties tab" /><figcaption aria-hidden="true"><em>The Cluster Properties tab</em></figcaption></figure>
...
<figure><img src="../images/downloading_an_ssh_key.png" class="align-center" alt="Downloading an SSH Key" /><figcaption aria-hidden="true"><em>Downloading an SSH Key</em></figcaption></figure>
...
<figure><img src="../images/taking_cluster_backup.png" class="align-center" alt="Taking a cluster backup" /><figcaption aria-hidden="true"><em>Taking a cluster backup</em></figcaption></figure>
...
<figure><img src="../images/backups_properties_tab.png" class="align-center" alt="The Backups Properties tab" /><figcaption aria-hidden="true"><em>The Backups Properties tab</em></figcaption></figure>
...
<figure><img src="../images/adding_replicas_to_cluster.png" class="align-center" alt="Adding replicas to a cluster" /><figcaption aria-hidden="true"><em>Adding replicas to a cluster</em></figcaption></figure>
...
<figure><img src="../images/removing_replicas_from_cluster.png" class="align-center" alt="Removing replicas from a cluster" /><figcaption aria-hidden="true"><em>Removing replicas from a cluster</em></figcaption></figure>
...
<figure><img src="../images/adding_storage_space_to_cluster.png" class="align-center" alt="Adding storage space to a cluster" /><figcaption aria-hidden="true"><em>Adding storage space to a cluster</em></figcaption></figure>
...
<figure><img src="../images/scaling_machine_type.png" class="align-center" alt="Scaling a machine type" /><figcaption aria-hidden="true"><em>Scaling a machine type</em></figcaption></figure>
...
<figure><img src="../images/upgrading_cluster.png" class="align-center" alt="Upgrading a Cluster" /><figcaption aria-hidden="true"><em>Upgrading a Cluster</em></figcaption></figure>
