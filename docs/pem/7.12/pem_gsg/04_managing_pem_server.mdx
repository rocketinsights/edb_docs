...
<figure><img src="images/pem_services_windows_server_agent.png" class="align-center" alt="The PEM service in the Windows Services window" /><figcaption aria-hidden="true"><em>The PEM service in the Windows Services window</em></figcaption></figure>
...
<figure><img src="images/pem_services_windows_server_agent.png" class="align-center" alt="The Management menu of a managed server" /><figcaption aria-hidden="true"><em>The Management menu of a managed server</em></figcaption></figure>
...
<figure><img src="images/pem_services_windows_server_agent.png" class="align-center" alt="The Windows Services window" /><figcaption aria-hidden="true"><em>The Windows Services window</em></figcaption></figure>
...
<figure><img src="images/pem_services_httpd.png" class="align-center" alt="The PEM HTTPD Windows service" /><figcaption aria-hidden="true"><em>The PEM HTTPD Windows service</em></figcaption></figure>
...
<figure><img src="images/pem_pg_hba.png" class="align-center" alt="PEM entries in the pg_hba.conf file" /><figcaption aria-hidden="true"><em>PEM entries in the pg_hba.conf file</em></figcaption></figure>
...
<figure><img src="images/pem_create_table.png" class="align-center" alt="Use PEM&#39;s dialogs to create and manage database objects" /><figcaption aria-hidden="true"><em>Use PEM's dialogs to create and manage database objects</em></figcaption></figure>
...
<figure><img src="images/pem_server_configuration.png" class="align-center" alt="The PEM Server Configuration dialog" /><figcaption aria-hidden="true"><em>The PEM Server Configuration dialog</em></figcaption></figure>
...
<figure><img src="images/pem_editing_server_configuration.png" class="align-center" alt="The Server Configuration dialog" /><figcaption aria-hidden="true"><em>The Server Configuration dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_login.png" class="align-center" alt="The context menu of the Login Roles node" /><figcaption aria-hidden="true"><em>The context menu of the Login Roles node</em></figcaption></figure>
...
<figure><img src="images/pem_create_login_dialog.png" class="align-center" alt="The Login Role dialog" /><figcaption aria-hidden="true"><em>The Login Role dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_login_membership.png" class="align-center" alt="The Membership tab" /><figcaption aria-hidden="true"><em>The Membership tab</em></figcaption></figure>
...
<figure><img src="images/pem_create_login_sql.png" class="align-center" alt="The SQL tab" /><figcaption aria-hidden="true"><em>The SQL tab</em></figcaption></figure>
...
<figure><img src="images/job_notifications_job_level.png" class="align-center" alt="Job notification configuration: job level" /><figcaption aria-hidden="true"><em>Job notification configuration: job level</em></figcaption></figure>
...
<figure><img src="images/job_notifications_agent_level.png" class="align-center" alt="Job notification configuration: agent level" /><figcaption aria-hidden="true"><em>Job notification configuration: agent level</em></figcaption></figure>
...
<figure><img src="images/job_notifications_server_level.png" class="align-center" alt="Job notification configuration: server level" /><figcaption aria-hidden="true"><em>Job notification configuration: server level</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_general.png" class="align-center" alt="PEM scheduled job dialog create schedule" /><figcaption aria-hidden="true"><em>PEM scheduled job dialog create schedule</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_steps.png" class="align-center" alt="PEM scheduled job dialog add steps" /><figcaption aria-hidden="true"><em>PEM scheduled job dialog add steps</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_steps_definition.png" class="align-center" alt="PEM scheduled job steps definition" /><figcaption aria-hidden="true"><em>PEM scheduled job steps definition</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_steps_definition_code.png" class="align-center" alt="PEM scheduled job steps definition code" /><figcaption aria-hidden="true"><em>PEM scheduled job steps definition code</em></figcaption></figure>
...
-   Use the context-sensitive field on the step definition dialog's `Code` tab to provide the SQL code or batch script that will be executed during the step:
    ...
    -   If the step invokes a batch script, provide the script in the `Code` field. If you are running on a Windows server, standard batch file syntax must be used. When running on a Linux server, any shell script may be used, provided that a suitable interpreter is specified on the first line (e.g. *\#!/bin/sh*). Along with the defined inline code, you can also provide the path of any batch script, shell script, or SQL file on the filesystem.
        ...
        To invoke a script on a Windows system, set the registry entry for *AllowBatchJobSteps* as true and restart the PEM agent. PEM registry entries are located in HKEY\_LOCAL\_MACHINE\\Software\\Wow6432Node\\EnterpriseDB\\PEM\\agent.
...
<figure><img src="images/create_pem_jobs_schedules.png" class="align-center" alt="PEM scheduled job dialog add schedule tab" /><figcaption aria-hidden="true"><em>PEM scheduled job dialog add schedule tab</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_schedules_repeat.png" class="align-center" alt="PEM scheduled job dialog schedule repeat tab" /><figcaption aria-hidden="true"><em>PEM scheduled job dialog schedule repeat tab</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_schedules_exceptions.png" class="align-center" alt="PEM scheduled job dialog exceptions tab" /><figcaption aria-hidden="true"><em>PEM scheduled job dialog exceptions tab</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_notifications.png" class="align-center" alt="PEM scheduled job dialog notifications tab" /><figcaption aria-hidden="true"><em>PEM scheduled job dialog notifications tab</em></figcaption></figure>
...
<figure><img src="images/create_pem_jobs_sql.png" class="align-center" alt="PEM scheduled job dialog SQL tab" /><figcaption aria-hidden="true"><em>PEM scheduled job dialog SQL tab</em></figcaption></figure>
