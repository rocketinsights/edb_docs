...
<figure><img src="images/pem_accessing_create_server_dialog.png" class="align-center" alt="Accessing the Create – Server dialog" /><figcaption aria-hidden="true"><em>Accessing the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_server_general.png" class="align-center" alt="The General tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The General tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_server_connection.png" class="align-center" alt="The Connection tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The Connection tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_server_ssl.png" class="align-center" alt="The SSL tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The SSL tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_server_ssh_tunnel.png" class="align-center" alt="The SSH Tunnel tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The SSH Tunnel tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_server_advanced.png" class="align-center" alt="The Advanced tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The Advanced tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="images/pem_create_server_pem_agent.png" class="align-center" alt="The PEM Agent tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The PEM Agent tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="images/pem_server_auto_discovery.png" class="align-center" alt="The PEM Auto Discovery dialog" /><figcaption aria-hidden="true"><em>The PEM Auto Discovery dialog</em></figcaption></figure>
...
<figure><img src="images/pem_global_overview.png" class="align-center" alt="The registered server" /><figcaption aria-hidden="true"><em>The registered server</em></figcaption></figure>
...
<figure><img src="images/pem_global_overview.png" class="align-center" alt="The Global Overview dashboard" /><figcaption aria-hidden="true"><em>The Global Overview dashboard</em></figcaption></figure>
