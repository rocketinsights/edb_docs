...
<figure><img src="images/streaming_replication_welcome.png" class="align-center" alt="The Streaming Replication wizard&#39;s Welcome window" /><figcaption aria-hidden="true"><em>The Streaming Replication wizard's Welcome window</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_refresh_packages.png" class="align-center" alt="Use the popup to refresh package data" /><figcaption aria-hidden="true"><em>Use the popup to refresh package data</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_master_server.png" class="align-center" alt="Specify information about the master node" /><figcaption aria-hidden="true"><em>Specify information about the master node</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_master_server_authentication.png" class="align-center" alt="Specify information about the master node" /><figcaption aria-hidden="true"><em>Specify information about the master node</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_standby_server.png" class="align-center" alt="Select the standby servers" /><figcaption aria-hidden="true"><em>Select the standby servers</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_standby_server_add_entry.png" class="align-center" alt="Select the standby servers" /><figcaption aria-hidden="true"><em>Select the standby servers</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_extension_summary.png" class="align-center" alt="The wizard&#39;s upgrade and extension window" /><figcaption aria-hidden="true"><em>The wizard's upgrade and extension window</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_standby_server.png" class="align-center" alt="Specify installation options for the master and standbys" /><figcaption aria-hidden="true"><em>Specify installation options for the master and standbys</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_download_packages.png" class="align-center" alt="The Download Packages dialog" /><figcaption aria-hidden="true"><em>The Download Packages dialog</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_schedule_setup.png" class="align-center" alt="Select a time to configure replication" /><figcaption aria-hidden="true"><em>Select a time to configure replication</em></figcaption></figure>
...
<figure><img src="images/streaming_replication_dashboard.png" class="align-center" alt="The Streaming Replication dashboard" /><figcaption aria-hidden="true"><em>The Streaming Replication dashboard</em></figcaption></figure>
