...
<figure><img src="images/package_deployment_welcome.png" class="align-center" alt="The Package Deployment Welcome dialog" /><figcaption aria-hidden="true"><em>The Package Deployment Welcome dialog</em></figcaption></figure>

Click `Next` to continue.

<figure><img src="images/package_deployment_mode_selection.png" class="align-center" alt="The deployment mode selection dialog" /><figcaption aria-hidden="true"><em>The deployment mode selection dialog</em></figcaption></figure>
...
<figure><img src="images/package_deployment_agent_server_selection.png" class="align-center" alt="Specify the target Agents and Servers" /><figcaption aria-hidden="true"><em>Specify the target Agents and Servers</em></figcaption></figure>
...
<figure><img src="images/package_deployment_select_applications.png" class="align-center" alt="Select which applications are to be installed" /><figcaption aria-hidden="true"><em>Select which applications are to be installed</em></figcaption></figure>
...
<figure><img src="images/package_deployment_specify_installation_option.png" class="align-center" alt="Specify installation options" /><figcaption aria-hidden="true"><em>Specify installation options</em></figcaption></figure>

Review the list of packages that will be installed, and (if prompted) provide any options requested. Click `Next` to continue.

<figure><img src="images/package_deployment_start_installer_download.png" class="align-center" alt="Starting the installer download" /><figcaption aria-hidden="true"><em>Starting the installer download</em></figcaption></figure>
...
<figure><img src="images/package_deployment_scheduler.png" class="align-center" alt="The Package Deployment scheduling dialog" /><figcaption aria-hidden="true"><em>The Package Deployment scheduling dialog</em></figcaption></figure>
...
<figure><img src="images/scheduled_task_tab.png" class="align-center" alt="The Scheduled Tasks tab" /><figcaption aria-hidden="true"><em>The Scheduled Tasks tab</em></figcaption></figure>
...
<figure><img src="images/select_package_upgrade.png" class="align-center" alt="Select the packages that will be upgraded" /><figcaption aria-hidden="true"><em>Select the packages that will be upgraded</em></figcaption></figure>

Expand the tree control, and check the box next to package you wish to upgrade. Click `Next` to continue.

<figure><img src="images/package_deployment_specify_installation_option.png" class="align-center" alt="Provide any requested installation options" /><figcaption aria-hidden="true"><em>Provide any requested installation options</em></figcaption></figure>
...
<figure><img src="images/package_deployment_start_installer_download.png" class="align-center" alt="Downloading the application installers" /><figcaption aria-hidden="true"><em>Downloading the application installers</em></figcaption></figure>
...
<figure><img src="images/package_deployment_scheduler.png" class="align-center" alt="Schedule a time for installation" /><figcaption aria-hidden="true"><em>Schedule a time for installation</em></figcaption></figure>
