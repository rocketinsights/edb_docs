...
<figure><img src="../images/setup_pem_server_on_same_host_welcome_wizard.png" class="align-center" alt="The PEM Server Installer&#39;s Welcome dialog" /><figcaption aria-hidden="true"><em>The PEM Server Installer's Welcome dialog</em></figcaption></figure>

Click `Next` to continue to the `License Agreement` dialog.

<figure><img src="../images/setup_pem_server_on_same_host_license_agreement.png" class="align-center" alt="The License Agreement" /><figcaption aria-hidden="true"><em>The License Agreement</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_installation_directory.png" class="align-center" alt="Specify an installation directory" /><figcaption aria-hidden="true"><em>Specify an installation directory</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_prerequisites_checks.png" class="align-center" alt="The installer checks for pre-requisites" /><figcaption aria-hidden="true"><em>The installer checks for pre-requisites</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_pgsql_credentials.png" class="align-center" alt="Enter the name and password of the PostgreSQL superuser" /><figcaption aria-hidden="true"><em>Enter the name and password of the PostgreSQL superuser</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_network_details.png" class="align-center" alt="Supply the network address from which the agent will connect" /><figcaption aria-hidden="true"><em>Supply the network address from which the agent will connect</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_agent_details.png" class="align-center" alt="Provide a Description for the agent that resides on the server" /><figcaption aria-hidden="true"><em>Provide a Description for the agent that resides on the server</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_installation_begins.png" class="align-center" alt="The installation is ready to begin" /><figcaption aria-hidden="true"><em>The installation is ready to begin</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_installation_in_progress.png" class="align-center" alt="The installation in progress" /><figcaption aria-hidden="true"><em>The installation in progress</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_installation_complete_popup.png" class="align-center" alt="A popup confirms the installation details" /><figcaption aria-hidden="true"><em>A popup confirms the installation details</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_same_host_installation_complete_wizard.png" class="align-center" alt="The PEM server installation is complete" /><figcaption aria-hidden="true"><em>The PEM server installation is complete</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_license_agreement.png" class="align-center" alt="The License Agreement" /><figcaption aria-hidden="true"><em>The License Agreement</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_installation_directory.png" class="align-center" alt="The Installation Directory dialog" /><figcaption aria-hidden="true"><em>The Installation Directory dialog</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_existing_postgres_server_web_services_and_database.png" class="align-center" alt="The Advanced Options dialog" /><figcaption aria-hidden="true"><em>The Advanced Options dialog</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_specifying_database_host_advanced_options_dialog_select_database.png" class="align-center" alt="The Advanced options dialog" /><figcaption aria-hidden="true"><em>The Advanced options dialog</em></figcaption></figure>

Click `Next` to continue to the `Database Server Selection` dialog.

<figure><img src="../images/setup_pem_server_on_separate_host__specifying_database_host_database_server_selection.png" class="align-center" alt="Selecting a database server" /><figcaption aria-hidden="true"><em>Selecting a database server</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_specifying_database_host_database_server_installation_details.png" class="align-center" alt="The Database Server Installation Details dialog" /><figcaption aria-hidden="true"><em>The Database Server Installation Details dialog</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_specifying_database_network_details.png" class="align-center" alt="Supply the network address from which the agent will connect" /><figcaption aria-hidden="true"><em>Supply the network address from which the agent will connect</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_specifying_database_agent_details.png" class="align-center" alt="Provide a Description for the agent" /><figcaption aria-hidden="true"><em>Provide a Description for the agent</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_installation_in_progress.png" class="align-center" alt="The installation in progress" /><figcaption aria-hidden="true"><em>The installation in progress</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_installation_complete_popup.png" class="align-center" alt="Click OK to confirm that the pem database has been created" /><figcaption aria-hidden="true"><em>Click OK to confirm that the pem database has been created</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_installing_web_services_advanced_options.png" class="align-center" alt="Selecting the Web Services option on the Advanced options dialog" /><figcaption aria-hidden="true"><em>Selecting the Web Services option on the Advanced options dialog</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_separate_host_installing_web_services_checking_components.png" class="align-center" alt="The installer has detected missing dependencies" /><figcaption aria-hidden="true"><em>The installer has detected missing dependencies</em></figcaption></figure>

Click `Next` to instruct the server to install LanguagePack

<figure><img src="../images/setup_pem_server_on_separate_host_installing_web_services_installing_missing_dependency_languagepack.png" class="align-center" alt="The installer has detected missing dependencies" /><figcaption aria-hidden="true"><em>The installer has detected missing dependencies</em></figcaption></figure>

After installing language pack, the installer will invoke the PEM-HTTPD setup wizard.

<figure><img src="../images/setup_pem_server_on_separate_host_PEM_httpd_installation_wizard.png" class="align-center" alt="The PEM-HTTPD installation wizard" /><figcaption aria-hidden="true"><em>The PEM-HTTPD installation wizard</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_installing_database_server.png" class="align-center" alt="The Database Server Installation Details dialog" /><figcaption aria-hidden="true"><em>The Database Server Installation Details dialog</em></figcaption></figure>
...
You can use an existing Postgres server (version 9.4 or later) to host the PEM server and the `pem` database. Postgres installers and pre-requisite software extensions are freely available on the [EnterpriseDB website at](http://www.enterprisedb.com/)
...
-   Create a service script (on Linux) or register the server with the Windows service manager. For more information, see [Creating a Service Script or Registering the Service](../03_installing_postgres_enterprise_manager/#creating_a_service_script_or_registering_the_service) section.
...
On Linux, the service script must reside in the `/etc/init.d` directory. The service script must be able to start, stop and restart the database server. Service scripts are platform-specific; you can find a sample service script for Linux in <span class="title-ref">Linux Service Script (Sample) &lt;reference\_linux\_service\_script&gt;</span> section. For information about customizing a Postgres service, visit:
...
>
> *user\_name* specifies the name of an operating system user with sufficient privileges to access the Postgres installation directory and start the Postgres service.
>
> *password* specifies the operating system password associated with the user.
>
> *data\_directory* specifies the location of the Postgres data directory.
...
<figure><img src="../images/setup_pem_server_on_separate_host__specifying_database_host_database_server_selection.png" class="align-center" alt="The Database Server Selection dialog" /><figcaption aria-hidden="true"><em>The Database Server Selection dialog</em></figcaption></figure>
...
For information about preparing a service script, please see [this section](../03_installing_postgres_enterprise_manager/#creating_a_service_script_or_registering_the_service)
...
<figure><img src="../images/setup_pem_server_on_same_host_agent_details.png" class="align-center" alt="Provide a Description for the agent that resides" /><figcaption aria-hidden="true"><em>Provide a Description for the agent that resides</em></figcaption></figure>
...
<figure><img src="../images/setup_pem_server_on_existing_postgres_server_installation_in_progress.png" class="align-center" alt="The installation in progress" /><figcaption aria-hidden="true"><em>The installation in progress</em></figcaption></figure>

During the installation process, the installer will copy files to the system, and set up the PEM server's backend database. A popup dialog opens confirming that the `pem` database has been created and configured.

<figure><img src="../images/setup_pem_server_on_same_host_installation_complete_popup.png" class="align-center" alt="Click OK to confirm that the pem database has been created" /><figcaption aria-hidden="true"><em>Click OK to confirm that the pem database has been created</em></figcaption></figure>
...
> *registered\_edb\_user* specifies the name of a registered EnterpriseDB user. To register, visit the [EDB website](https://www.enterprisedb.com/user/register)
>
> *edb\_user\_password* specifies the password associated with the EDB user account.
>
> *port* specifies the port used by the backing PostgreSQL database; by default, the PostgreSQL database uses port `5432`.
>
> *cidr\_address\_range* specifies the address range that will be added to the `pg_hba.conf` file of the PEM server's backing database to allow connections from the agents that will be monitored by the server. You may wish to specify a network range (for example, 192.168.2.0/24) to provide server access to agents that reside on the same network.
>
> *windows\_password* specifies the password associated with the Windows Administrator's account.
