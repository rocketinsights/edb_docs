...
<figure><img src="images/pem_upgrade_agent_license.png" class="align-center" alt="The PEM license agreement" /><figcaption aria-hidden="true"><em>The PEM license agreement</em></figcaption></figure>
...
<figure><img src="images/pem_specify_installation_directory.png" class="align-center" alt="Specify an Installation Directory" /><figcaption aria-hidden="true"><em>Specify an Installation Directory</em></figcaption></figure>
...
<figure><img src="images/pem_server_installation_details.png" class="align-center" alt="Provide PEM server installation details" /><figcaption aria-hidden="true"><em>Provide PEM server installation details</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installation_details.png" class="align-center" alt="Specify a descriptive name for the PEM agent" /><figcaption aria-hidden="true"><em>Specify a descriptive name for the PEM agent</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installer_cert_path.png" class="align-center" alt="Provide the certificate path" /><figcaption aria-hidden="true"><em>Provide the certificate path</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installation_ready_to_begin.png" class="align-center" alt="The PEM Agent installation is ready to begin" /><figcaption aria-hidden="true"><em>The PEM Agent installation is ready to begin</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installation_in_progress.png" class="align-center" alt="Progress bars mark the installation&#39;s progress" /><figcaption aria-hidden="true"><em>Progress bars mark the installation's progress</em></figcaption></figure>

The PEM agent installer displays progress bars to mark the PEM agent's installation progress.

<figure><img src="images/pem_agent_installation_completed.png" class="align-center" alt="The PEM Agent installation is complete" /><figcaption aria-hidden="true"><em>The PEM Agent installation is complete</em></figcaption></figure>
