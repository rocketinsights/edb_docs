...
1.  Edit the `postgresql.conf` file; you must include the SQL Profiler library in the shared\_preload\_libraries configuration parameter.
...
<figure><img src="images/trace_option_tab.png" class="align-center" alt="The Trace options tab" /><figcaption aria-hidden="true"><em>The Trace options tab</em></figcaption></figure>
...
<figure><img src="images/trace_schedule_tab.png" class="align-center" alt="The Create trace Schedule tab" /><figcaption aria-hidden="true"><em>The Create trace Schedule tab</em></figcaption></figure>
...
<figure><img src="images/trace_periodic_job_options.png" class="align-center" alt="The Create trace Periodic job options tab" /><figcaption aria-hidden="true"><em>The Create trace Periodic job options tab</em></figcaption></figure>
...
<figure><img src="images/sql_profiler_trace_result.png" class="align-center" alt="The SQL Profiler tab, displaying the trace results" /><figcaption aria-hidden="true"><em>The SQL Profiler tab, displaying the trace results</em></figcaption></figure>
...
<figure><img src="images/open_existing_trace.png" class="align-center" alt="Opening an existing trace" /><figcaption aria-hidden="true"><em>Opening an existing trace</em></figcaption></figure>
...
<figure><img src="images/delete_trace.png" class="align-center" alt="The Delete traces… dialog" /><figcaption aria-hidden="true"><em>The Delete traces… dialog</em></figcaption></figure>
...
<figure><img src="images/review_scheduled_trace.png" class="align-center" alt="Reviewing scheduled traces" /><figcaption aria-hidden="true"><em>Reviewing scheduled traces</em></figcaption></figure>
...
1.  Modify the `postgresql.conf` file on each Advanced Server host, adding the index\_advisor library to the shared\_preload\_libraries parameter.
