...
-   Before associating a database server with a BART server, you must authorize SSH/SCP access without a password prompt and enable WAL archiving for the managed database server. For more information about authorizing SSH/SCP access without a password prompt and enabling WAL archiving, please see *BART Installation Guide* available at:
...
-   To restore a BART backup, you must install the PEM agent as well as BART on the target server.
...
<figure><img src="images/create_BART_server_general.png" class="align-center" alt="The Create-BART server dialog - General tab" /><figcaption aria-hidden="true"><em>The Create-BART server dialog - General tab</em></figcaption></figure>
...
<figure><img src="images/create_BART_server_misc.png" class="align-center" alt="The Create-BART server dialog - Misc tab" /><figcaption aria-hidden="true"><em>The Create-BART server dialog - Misc tab</em></figcaption></figure>
...
<figure><img src="images/create_server_bart_general.png" class="align-center" alt="The Create Server dialog (BART - General tab)" /><figcaption aria-hidden="true"><em>The Create Server dialog (BART - General tab)</em></figcaption></figure>
...
-   Use the `Archive command` field to specify the desired format of the archive command string to be used in bart.cfg file.
-   Use the `Allow incremental backup` field to specify if incremental backup should be enabled for this database server.

<figure><img src="images/create_server_bart_misc.png" class="align-center" alt="The Create - Server dialog (BART - Misc tab)" /><figcaption aria-hidden="true"><em>The Create - Server dialog (BART - Misc tab)</em></figcaption></figure>
...
-   Use the `Copy WALs during restore` field to specify how the archived WAL files are collected when invoking the RESTORE operation. Set to enabled to copy the archived WAL files from the BART backup catalog to the &lt;restore\_path&gt;/archived\_wals directory prior to the database server archive recovery. Set to disabled to retrieve the archived WAL files directly from the BART backup catalog during the database server archive recovery.
...
<figure><img src="images/bart_backup_dashboard.png" class="align-center" alt="The BART Backup Dashboard" /><figcaption aria-hidden="true"><em>The BART Backup Dashboard</em></figcaption></figure>
...
The red pin in the first column under `Actions` indicates that a backup is marked as `Keep` while a green one indicates that the backup is marked as `NoKeep`. The second column under `Actions` displays the `Restore` icon; you can perform the `Restore` operation by clicking on the icon.
...
<figure><img src="images/BART_backup_scheduler_general.png" class="align-center" alt="The Schedule Backup dialog - General options" /><figcaption aria-hidden="true"><em>The Schedule Backup dialog - General options</em></figcaption></figure>
...
-   Use the `pg_basebackup` field to specify if the pg\_basebackup utility should be used for the backup. Typically, pg\_basebackup utility is used only for backing up the standby servers since it cannot be used for incremental backups.

<figure><img src="images/BART_backup_scheduler_schedule_general.png" class="align-center" alt="The Schedule Backup dialog - (Schedule : General)" /><figcaption aria-hidden="true"><em>The Schedule Backup dialog - (Schedule : General)</em></figcaption></figure>
...
<figure><img src="images/BART_backup_scheduler_schedule_repeat.png" class="align-center" alt="The Schedule Backup dialog - (Schedule : Repeat)" /><figcaption aria-hidden="true"><em>The Schedule Backup dialog - (Schedule : Repeat)</em></figcaption></figure>
...
<figure><img src="images/BART_backup_scheduler_schedule_notifications.png" class="align-center" alt="The Schedule Backup dialog - (Schedule : Notifications)" /><figcaption aria-hidden="true"><em>The Schedule Backup dialog - (Schedule : Notifications)</em></figcaption></figure>
...
Restore of an incremental backup is not yet supported by BART.

</div>

To restore a backup, click the `Restore` icon next to the backup that you want to restore.

<figure><img src="images/BART_backup_restore_general.png" class="align-center" alt="The Restore Backup dialog - General" /><figcaption aria-hidden="true"><em>The Restore Backup dialog - General</em></figcaption></figure>
...
<figure><img src="images/BART_backup_restore_advanced.png" class="align-center" alt="The Restore Backup dialog - Advanced" /><figcaption aria-hidden="true"><em>The Restore Backup dialog - Advanced</em></figcaption></figure>
...
<figure><img src="images/BART_backup_restore_notifications.png" class="align-center" alt="The Restore Backup dialog - Notifications" /><figcaption aria-hidden="true"><em>The Restore Backup dialog - Notifications</em></figcaption></figure>
