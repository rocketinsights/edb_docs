...
<figure><img src="images/EPAS_instance.png" class="align-center" alt="The Service ID of the Advanced Server instance" /><figcaption aria-hidden="true"><em>The Service ID of the Advanced Server instance</em></figcaption></figure>
...
<figure><img src="images/EDB_audit_config_probe.png" class="align-center" alt="The EDB Audit Configuration probe" /><figcaption aria-hidden="true"><em>The EDB Audit Configuration probe</em></figcaption></figure>
...
<figure><img src="images/audit_manager_welcome.png" class="align-center" alt="The Audit Manager Welcome dialog" /><figcaption aria-hidden="true"><em>The Audit Manager Welcome dialog</em></figcaption></figure>

Click `Next` to continue.

<figure><img src="images/audit_manager_select_server.png" class="align-center" alt="Select the servers you wish to configure for auditing" /><figcaption aria-hidden="true"><em>Select the servers you wish to configure for auditing</em></figcaption></figure>
...
<figure><img src="images/audit_manager_configuration.png" class="align-center" alt="The Auditing Parameters Configuration dialog" /><figcaption aria-hidden="true"><em>The Auditing Parameters Configuration dialog</em></figcaption></figure>
...
<figure><img src="images/audit_manager_log_parameters.png" class="align-center" alt="The Audit Log Configuration dialog" /><figcaption aria-hidden="true"><em>The Audit Log Configuration dialog</em></figcaption></figure>
...
<figure><img src="images/audit_manager_schedule.png" class="align-center" alt="The Schedule Auditing Changes dialog" /><figcaption aria-hidden="true"><em>The Schedule Auditing Changes dialog</em></figcaption></figure>
...
<figure><img src="images/audit_log_dashboard.png" class="align-center" alt="The Audit Log dashboard" /><figcaption aria-hidden="true"><em>The Audit Log dashboard</em></figcaption></figure>
...
<figure><img src="images/audit_log_dashboard_filter.png" class="align-center" alt="The Audit Log dashboard filters panel" /><figcaption aria-hidden="true"><em>The Audit Log dashboard filters panel</em></figcaption></figure>
