...
Please note that only superusers or the users with the pem\_admin role permission can download the System Configuration or Core Usage reports.
...
<figure><img src="images/system_configuration_report_pem_summary_and_summary.png" class="align-center" alt="System Configuration Report - PEM Summary and Summary" /><figcaption aria-hidden="true"><em>System Configuration Report - PEM Summary and Summary</em></figcaption></figure>

The *Group: PEM Agents* panel provides details about the PEM agent, CPU cores, Disk Utilization, and Memory information.

<figure><img src="images/system_configuration_report_pem_agents.png" class="align-center" alt="System Configuration Report - PEM Agents" /><figcaption aria-hidden="true"><em>System Configuration Report - PEM Agents</em></figcaption></figure>
...
<figure><img src="images/system_configuration_report_pem_server_directory.png" class="align-center" alt="System Configuration Report - Group Server Name" /><figcaption aria-hidden="true"><em>System Configuration Report - Group Server Name</em></figcaption></figure>
...
<figure><img src="images/core_usage_report.png" class="align-center" alt="Core Usage Report" /><figcaption aria-hidden="true"><em>Core Usage Report</em></figcaption></figure>
