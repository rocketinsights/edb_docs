...
<figure><img src="images/query_tool.png" class="align-center" alt="The PEM Query Tool" /><figcaption aria-hidden="true"><em>The PEM Query Tool</em></figcaption></figure>
...
<figure><img src="images/query_toolbar.png" class="align-center" alt="The Query Tool Toolbar" /><figcaption aria-hidden="true"><em>The Query Tool Toolbar</em></figcaption></figure>
...
<figure><img src="images/query_sql_editor.png" class="align-center" alt="The SQL Editor Panel" /><figcaption aria-hidden="true"><em>The SQL Editor Panel</em></figcaption></figure>
...
<figure><img src="images/query_autocomplete.png" class="align-center" alt="Using Auto-complete" /><figcaption aria-hidden="true"><em>Using Auto-complete</em></figcaption></figure>
...
<figure><img src="images/query_execute_section.png" class="align-center" alt="Executing a command" /><figcaption aria-hidden="true"><em>Executing a command</em></figcaption></figure>
...
<figure><img src="images/query_tool_message.png" class="align-center" alt="The Messages Tab" /><figcaption aria-hidden="true"><em>The Messages Tab</em></figcaption></figure>
...
<figure><img src="images/query_output_data.png" class="align-center" alt="The Data Output Panel" /><figcaption aria-hidden="true"><em>The Data Output Panel</em></figcaption></figure>
...
<figure><img src="images/query_tool_editable_columns.png" class="align-center" alt="Query Tool Editable Columns" /><figcaption aria-hidden="true"><em>Query Tool Editable Columns</em></figcaption></figure>
...
<figure><img src="images/query_toolbar_explain.png" class="align-center" alt="The Explain Options" /><figcaption aria-hidden="true"><em>The Explain Options</em></figcaption></figure>
...
<figure><img src="images/query_output_explain_details.png" class="align-center" alt="A Graphical Explain" /><figcaption aria-hidden="true"><em>A Graphical Explain</em></figcaption></figure>
...
<figure><img src="images/query_explain_analyze_table.png" class="align-center" alt="The Analysis Tab" /><figcaption aria-hidden="true"><em>The Analysis Tab</em></figcaption></figure>
...
<figure><img src="images/query_explain_analyze_statistics.png" class="align-center" alt="The Statistics Tab" /><figcaption aria-hidden="true"><em>The Statistics Tab</em></figcaption></figure>

### Messages Tab

Use the *Messages* tab to view information about the most recently executed query:

<figure><img src="images/query_output_error.png" class="align-center" alt="The Messages Tab" /><figcaption aria-hidden="true"><em>The Messages Tab</em></figcaption></figure>
...
<figure><img src="images/query_output_messages.png" class="align-center" alt="A successful query" /><figcaption aria-hidden="true"><em>A successful query</em></figcaption></figure>

### Notifications Tab

Use the *Notifications* tab to view details of the asynchronous notifications that a client process may have sent:

<figure><img src="images/query_output_notifications.png" class="align-center" alt="The Notifications Tab" /><figcaption aria-hidden="true"><em>The Notifications Tab</em></figcaption></figure>
...
<figure><img src="images/query_output_history.png" class="align-center" alt="The Query History Tab" /><figcaption aria-hidden="true"><em>The Query History Tab</em></figcaption></figure>
...
<figure><img src="images/query_tool_connection_status.png" class="align-center" alt="Checking the Connection Status" /><figcaption aria-hidden="true"><em>Checking the Connection Status</em></figcaption></figure>
...
<figure><img src="images/query_tool_connection_status_error.png" class="align-center" alt="The connection check failed" /><figcaption aria-hidden="true"><em>The connection check failed</em></figcaption></figure>
