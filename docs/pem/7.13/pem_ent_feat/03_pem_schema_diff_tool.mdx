...
<div id="pem_schema_diff_tool" class="registered_link"></div>
...
<figure><img src="images/schema_diff_dialog.png" class="align-center" alt="Schema Diff dialog" /><figcaption aria-hidden="true"><em>Schema Diff dialog</em></figcaption></figure>
...
<figure><img src="images/schema_diff_compare_button.png" class="align-center" alt="Schema Diff dialog - Compare button" /><figcaption aria-hidden="true"><em>Schema Diff dialog - Compare button</em></figcaption></figure>

After you select servers, databases, and schemas, click on the `Compare` button to obtain the `Comparison Result`.

<figure><img src="images/schema_diff_comparison_results.png" class="align-center" alt="Schema Diff dialog - Comparison Results" /><figcaption aria-hidden="true"><em>Schema Diff dialog - Comparison Results</em></figcaption></figure>
...
<figure><img src="images/schema_diff_filter_option.png" class="align-center" alt="Schema Diff dialog - Filter option" /><figcaption aria-hidden="true"><em>Schema Diff dialog - Filter option</em></figcaption></figure>
...
<figure><img src="images/schema_diff_DDL_comparison.png" class="align-center" alt="Schema Diff dialog - DDL Comparison panel" /><figcaption aria-hidden="true"><em>Schema Diff dialog - DDL Comparison panel</em></figcaption></figure>
...
<figure><img src="images/schema_diff_generate_script.png" class="align-center" alt="Schema Diff dialog - Generate Script button" /><figcaption aria-hidden="true"><em>Schema Diff dialog - Generate Script button</em></figcaption></figure>
...
<figure><img src="images/schema_diff_generate_script_query_editor.png" class="align-center" alt="Schema Diff dialog - Generate Script - Query Editor" /><figcaption aria-hidden="true"><em>Schema Diff dialog - Generate Script - Query Editor</em></figcaption></figure>
