...
<div id="the_pem_server_pem_agent_connection_management_mechanism" class="registered_link"></div>
...
<figure><img src="images/pem_database_without_pgbouncer.png" class="align-center" alt="Connecting to the PEM database without pgBouncer" /><figcaption aria-hidden="true"><em>Connecting to the PEM database without pgBouncer</em></figcaption></figure>
...
<figure><img src="images/pem_database_with_pgbouncer.png" class="align-center" alt="Connecting to pgBouncer." /><figcaption aria-hidden="true"><em>Connecting to pgBouncer.</em></figcaption></figure>
