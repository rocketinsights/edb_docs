...
For information about using the `pemworker` utility to register a server, please see the [PEM Administrator's Guide](https://www.enterprisedb.com/resources/product-documentation)
