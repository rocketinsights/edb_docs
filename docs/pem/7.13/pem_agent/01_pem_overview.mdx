...
<figure><img src="images/pem_architecture.png" class="align-center" alt="A typical PEM installation." /><figcaption aria-hidden="true"><em>A typical PEM installation.</em></figcaption></figure>
