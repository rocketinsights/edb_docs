...
<figure><img src="images/pem_upgrade_agent_welcome.png" class="align-center" alt="PEM Agent Installation - Welcome window" /><figcaption aria-hidden="true"><em>PEM Agent Installation - Welcome window</em></figcaption></figure>

Click `Next` to continue to the `License Agreement`.

<figure><img src="images/pem_upgrade_agent_license.png" class="align-center" alt="PEM Agent Installation - License Agreement" /><figcaption aria-hidden="true"><em>PEM Agent Installation - License Agreement</em></figcaption></figure>
...
<figure><img src="images/pem_specify_installation_directory.png" class="align-center" alt="PEM Agent Installation - Installation Directory" /><figcaption aria-hidden="true"><em>PEM Agent Installation - Installation Directory</em></figcaption></figure>
...
<figure><img src="images/pem_server_installation_details.png" class="align-center" alt="PEM Agent Installation - PEM server installation details" /><figcaption aria-hidden="true"><em>PEM Agent Installation - PEM server installation details</em></figcaption></figure>
...
<figure><img src="images/pem_agent_service_account_password.png" class="align-center" alt="PEM Agent Installation - pemAgent Service Account password" /><figcaption aria-hidden="true"><em>PEM Agent Installation - pemAgent Service Account password</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installation_details.png" class="align-center" alt="PEM Agent Installation - Agent Details" /><figcaption aria-hidden="true"><em>PEM Agent Installation - Agent Details</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installer_cert_path.png" class="align-center" alt="PEM Agent Installation - Advanced Options - Certificate Path" /><figcaption aria-hidden="true"><em>PEM Agent Installation - Advanced Options - Certificate Path</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installation_ready_to_begin.png" class="align-center" alt="PEM Agent Installation - Ready to Install" /><figcaption aria-hidden="true"><em>PEM Agent Installation - Ready to Install</em></figcaption></figure>
...
<figure><img src="images/pem_agent_installation_in_progress.png" class="align-center" alt="PEM Agent Installation - Installing Progress" /><figcaption aria-hidden="true"><em>PEM Agent Installation - Installing Progress</em></figcaption></figure>

The PEM agent installer displays progress bars to mark the PEM agent's installation progress.

<figure><img src="images/pem_agent_installation_completed.png" class="align-center" alt="PEM Agent Installation - Finish" /><figcaption aria-hidden="true"><em>PEM Agent Installation - Finish</em></figcaption></figure>
...
<figure><img src="images/pem_rpm_installation_agent.png" class="align-center" alt="Using an RPM package to install the PEM agent" /><figcaption aria-hidden="true"><em>Using an RPM package to install the PEM agent</em></figcaption></figure>
