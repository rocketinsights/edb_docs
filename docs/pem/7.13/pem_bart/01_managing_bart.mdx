...
-   To take a backup of the standby database servers, you must ensure that the latest *pg\_basebackup* utility is installed on the database server that you want to manage through BART.
