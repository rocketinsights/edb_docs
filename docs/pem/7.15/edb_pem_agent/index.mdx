...
For information about the installation, uninstallation, or upgrading of a PEM Agent, visit the EnterpriseDB website at:
...
pem_overview registering_agent managing_pem_agent pem_agent_troubleshooting conclusion
