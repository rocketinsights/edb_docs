...
<figure><img src="../images/pem_agent_welcome_dialog.png" class="align-center" alt="PEM Agent Wizard - Welcome dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - Welcome dialog</em></figcaption></figure>

Click `Next` to continue to the `License Agreement`.

<figure><img src="../images/pem_agent_windows_license_agreement.png" class="align-center" alt="PEM Agent Wizard - License Agreement dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - License Agreement dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_agent_windows_installation_directory.png" class="align-center" alt="PEM Agent Wizard - Installation Directory dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - Installation Directory dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_agent_pem_server_windows_installation_details.png" class="align-center" alt="PEM Agent Wizard - PEM Server Installation details dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - PEM Server Installation details dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_agent_service_account_windows_password.png" class="align-center" alt="PEM Agent Wizard - pemAgent Service Account password dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - pemAgent Service Account password dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_agent_windows_agent_details.png" class="align-center" alt="PEM Agent Wizard - Naming PEM agent dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - Naming PEM agent dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_agent_windows_advanced_options_certificate_path.png" class="align-center" alt="PEM Agent Wizard - Advanced Options - Certificate Path dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - Advanced Options - Certificate Path dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_agent_windows_installation_ready_to_begin.png" class="align-center" alt="PEM Agent Wizard - Ready to install" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - Ready to install</em></figcaption></figure>
...
<figure><img src="../images/pem_agent_windows_installation_in_progress.png" class="align-center" alt="PEM Agent Wizard - Installation in progress" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - Installation in progress</em></figcaption></figure>

The PEM agent installer displays progress bars to mark the PEM agent's installation progress.

<figure><img src="../images/pem_agent_windows_installation_complete.png" class="align-center" alt="PEM Agent Wizard - Finish Installation dialog" /><figcaption aria-hidden="true"><em>PEM Agent Wizard - Finish Installation dialog</em></figcaption></figure>
