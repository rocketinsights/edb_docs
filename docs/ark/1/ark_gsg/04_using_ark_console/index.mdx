...
that reside in an AWS or Azure cloud:
  ...
  - The `Clusters` tab provides a management and information resources
    for your clusters.
  - The `Backups` tab provides a list of the existing snapshots of your
    ...
    snapshot.
  - The `User` tab provides a graphical management interface that you
    can use to review and manage your user account information.

Please note that some features of the Ark console are not available to a

[Template Only](template_only_user) user.
