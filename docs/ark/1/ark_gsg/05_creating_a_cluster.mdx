...
If you are a Template Only user or select the `Launch From Template` option on the deployment method selection dialog, a dialog opens that allows you to use a pre-defined template for the cluster configuration; for detailed information about using a template to create a cluster, see [Using a Template to Create a Cluster ](05_creating_a_cluster#template_create_cluster) .

If you select `Manually Define A Cluster`, a dialog opens that allows you to specify detailed information about the cluster configuration. For information about manually defining a cluster, see [Manually Creating a Cluster ](11_cds_creating_server_cluster#manually_create_cluster) .

You can also use an existing cluster or a backup as a starting point for a new cluster:

  - For information about cloning a new server cluster from an existing cluster, see [Cloning a Server Cluster ](05_creating_a_cluster#clone_server_cluster) .
...
Using a Template to Create a Cluster Create Cluster, Template Only User
...
Clone cluster with template Using a Template to Clone a Cluster
...
Modifying a Cluster's Administrative Settings Administrative Settings
