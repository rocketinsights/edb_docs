...
``Create an :ref:[Azure user account with sufficient privileges ](../06_ark_installing_console/02_ark_installing_console_azure#provide_access_azure) to access the Ark Administrator's console.`` Create an [Azure network security group ](../06_ark_installing_console/02_ark_installing_console_azure#azure_security_group) .

``Create an :ref:[Azure storage account ](../06_ark_installing_console/02_ark_installing_console_azure#azure_storage_account) .`` Launch a [VM Image ](../06_ark_installing_console/02_ark_installing_console_azure#azure_launch_ark_console) that contains the Ark console.

``Configure the :ref:[Ark console ](../06_ark_installing_console/02_ark_installing_console_azure#azure_configure_ark_console) .`` Register an [Ark Administrative user ](../06_ark_installing_console/02_ark_installing_console_azure#azure_register_user) .
...
After connecting to the Ark console, you should:
  ...
  - Use the :ref:`` `Admin `` tab \<ark_using_admin_tab\>\` to create the server ../images and database engines that will be used by non-administrative users.
