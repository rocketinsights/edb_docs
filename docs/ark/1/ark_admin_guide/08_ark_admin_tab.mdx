...
For detailed information about creating a statically provisioned image, please see [Creating a Statically Provisioned Image](ark_statically_provisioned).
...
\- For an Amazon-hosted console, review the AWS [deployment instructions](ark_installing_console_aws).

\- For an Azure-hosted console, review the Azure console [deployment instructions](ark_installing_console_azure).
