...
For more information about creating and using federated consoles, see `Using the Console Manager to Create a Federated Console <register_federated_console>`_.
...
For detailed information about creating a statically provisioned image, please see `Creating a Statically Provisioned Image <ark_statically_provisioned>`_.
...
For detailed descriptions of each field:
  ...
  - For an Amazon-hosted console, review the AWS `deployment instructions <ark_installing_console_aws>`_.
  - For an Azure-hosted console, review the Azure console `deployment instructions <ark_installing_console_azure>`_.
