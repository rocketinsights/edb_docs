...
<figure><img src="images/welcome.png" class="align-center" alt="The StackBuilder Plus Welcome window" /><figcaption aria-hidden="true"><em>The StackBuilder Plus Welcome window</em></figcaption></figure>
...
<figure><img src="images/installing_pgpoool.png" class="align-center" alt="Installing pgpool-II png" /><figcaption aria-hidden="true"><em>Installing pgpool-II png</em></figcaption></figure>

1.  Select an installation language and click `OK`.

<figure><img src="images/language_selection.png" class="align-center" alt="The language selection window" /><figcaption aria-hidden="true"><em>The language selection window</em></figcaption></figure>

1.  The pgpool installer welcomes you to the setup wizard.

<figure><img src="images/pgpool1.png" class="align-center" alt="The pgpool-II Welcome window" /><figcaption aria-hidden="true"><em>The pgpool-II Welcome window</em></figcaption></figure>
...
<figure><img src="images/pgpool2.png" class="align-center" alt="The pgpool-II Installation Details Window" /><figcaption aria-hidden="true"><em>The pgpool-II Installation Details Window</em></figcaption></figure>
...
<figure><img src="images/pgpool3.png" class="align-center" alt="The pgpool-II Operating User window" /><figcaption aria-hidden="true"><em>The pgpool-II Operating User window</em></figcaption></figure>
...
<figure><img src="images/pgpool4.png" class="align-center" alt="The Ready to Install window" /><figcaption aria-hidden="true"><em>The Ready to Install window</em></figcaption></figure>

1.  Progress bars inform you as the installation progresses.

<figure><img src="images/pgpool5.png" class="align-center" alt="The installation progresses" /><figcaption aria-hidden="true"><em>The installation progresses</em></figcaption></figure>
...
<figure><img src="images/pgpool6.png" class="align-center" alt="The installation is complete" /><figcaption aria-hidden="true"><em>The installation is complete</em></figcaption></figure>
