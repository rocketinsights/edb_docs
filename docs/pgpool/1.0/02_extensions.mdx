\<div id="extensions" class="registered\_link"\>\</div\>
...
\<div id="installing\_extensions\_using\_the\_SLES\_host" class="registered\_link"\>\</div\>
...
2.  Use the following command to add the EnterpriseDB repository to your SLES host.
...
3.  Use the following command to refresh the metadata on your SLES host to include the EnterpriseDB repository:
...
4.  Then, use the zypper utility to install pgpool-II extension:
...
\<div id="pgpool\_adm" class="registered\_link"\>\</div\>
...
\<div id="pgpool\_recovery" class="registered\_link"\>\</div\>
