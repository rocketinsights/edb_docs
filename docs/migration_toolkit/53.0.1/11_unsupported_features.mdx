...
Migration Toolkit supports the migration of packages from an Oracle database into Advanced Server. See the `Functionality Overview Section <functionality_overview>` for information about the migration support offered by Advanced Server.
