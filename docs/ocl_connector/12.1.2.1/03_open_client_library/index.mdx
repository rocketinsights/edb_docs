...
installing_and_configuring_the_ocl_connector forming_a_connection_string compiling_and_linking_a_program ref_cursor_support ocl_function_reference ocl_error_codes_reference multithreading_support
