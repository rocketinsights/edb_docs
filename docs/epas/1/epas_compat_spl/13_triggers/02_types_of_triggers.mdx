...
In a compound trigger, a statement-level and a row-level trigger can be defined in a single trigger and can be fired at more than one timing point see, [Compound Triggers](compound_triggers) for information about compound triggers.
