...
The rules for invoking subprograms based upon block location is described starting with [Invoking Subprograms](invoking_subprograms). The rules for accessing variables based upon block location is described in
