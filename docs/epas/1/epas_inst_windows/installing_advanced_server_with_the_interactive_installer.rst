.. _installing_advanced_server_with_the_interactive_installer:

******************************************************************
`Installing Advanced Server with the Interactive Installer`:index:
******************************************************************
...
During an installation, the graphical installer invokes the PostgreSQL ``initdb`` utility to initialize a cluster. If you are using the graphical
installer, you can use the ``INITDBOPTS`` environment variable to specify your ``initdb`` preferences. Before invoking the graphical installer, set the value of ``INITDBOPTS`` at the command line, specifying one or more cluster options. For example:
