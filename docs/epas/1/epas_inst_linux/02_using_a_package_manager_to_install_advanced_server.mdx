...
behavior of the server by [modifying the postgresql.conf
File](modifying_the_postgresqlconf_file).
...
For more information, see [Configuring a Package
Installation](configuring_a_package_installation).
...
[Installing Advanced Server on a Linux
Host](installing_advanced_server_on_a_linux_host).
...
File on CentOS or Redhat
6.x](using_a_service_configuration_file_on_centos_or_redhat_6x)), assume
`root`
...
[Specifying Cluster Options with
INITDBOPTS](specifying_cluster_options_with_initdbopts).
