...
| table_name   | | The name (optionally schema-qualified) of the table that the data redaction policy is on. | CASCADE | RESTRICT | These keywords do not have any effect, since there are no dependencies on the data redaction policies. |
