<div id="virtual_private_database">
...
metaTitle: Virtual Private Database
metaDescription: description
---

`Virtual Private Database` is a type of fine-grained access control
using security policies. `Fine-grained access control` means that access
to data can be controlled down to specific rows as defined by the
security policy.
...
supported by Advanced Server such as SQL and PL/pgSQL in addition to
SPL.
