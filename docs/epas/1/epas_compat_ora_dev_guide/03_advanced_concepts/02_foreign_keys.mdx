...
A modified version of the `emp` table presented in [Creating a New Table](creating_a_new_table) is shown in this section with the addition of a foreign key constraint. The modified `emp` table looks like the following:
