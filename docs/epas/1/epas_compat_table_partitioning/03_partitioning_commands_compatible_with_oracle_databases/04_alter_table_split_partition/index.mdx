...
> 
> For information about creating a `DEFAULT` or `MAXVALUE` partition, see

[Handling Stray Values in a LIST or RANGE Partitioned Table](handling_stray_values_in_a_list_or_range_partitioned_table).
