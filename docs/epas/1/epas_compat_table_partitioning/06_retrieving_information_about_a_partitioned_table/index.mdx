...
The structure of each view is explained in [Table Partitioning Views - Reference](table_partitioning_views_reference). If you are using the EDB-PSQL client, you can also discover the structure of a view by entering:
