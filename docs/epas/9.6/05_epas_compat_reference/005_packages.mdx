...
For more information about the package support provided by Advanced Server, please see the *Database Compatibility for Oracle Developers Built-in Package Guide*, available at:

<https://www.enterprisedb.com/docs/en/9.6/DB_Compat_Oracle_Built_in_Package/Database_Compatibility_for_Oracle_Developers_Built-in_Package_Guide.1.01.html>

For a list of built-in packages, see the Table of Contents, beginning with Chapter 3 "Built-In Packages" of the *Database Compatibility for Oracle Developers Built-in Package Guide*, available at:

<https://www.enterprisedb.com/docs/en/9.6/DB_Compat_Oracle_Built_in_Package/toc.html>
