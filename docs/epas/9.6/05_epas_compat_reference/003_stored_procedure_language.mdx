...
\\i C:/Program Files/PostgresPlus/9.6AS/installer/server/edb-sample.sql
...
Table 4‑3‑2 Exception Condition Names
...
Table 4‑3‑4 Permitted Cursor Variable Parameter Modes
