...
To set a value for the dbms\_alert.max\_alerts variable, open the postgresql.conf file (located by default in /opt/PostgresPlus/9.6AS/data) with your choice of editor, and edit the dbms\_alert.max\_alerts parameter as shown:
...
Version: EnterpriseDB 9.6.0.0 on i686-pc-linux-gnu, compiled by GCC gcc (GCC) 4.1.2 20080704 (Red Hat 4.1.2-48), 32-bit

Compatibility: EnterpriseDB 9.6.0.0 on i686-pc-linux-gnu, compiled by GCC gcc (GCC) 4.1.220080704 (Red Hat 4.1.2-48), 32-bit
