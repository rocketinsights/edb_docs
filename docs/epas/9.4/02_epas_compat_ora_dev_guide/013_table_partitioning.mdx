...
## Oracle Compatible Partitioning Commands

The following sections provide information about using the Oracle-compatible table partitioning syntax supported by Advanced Server.
...
For more information about using the MAXVALUE keyword, see [Section 13.4](#_Handling_Stray_Values_11).
...
For information about creating a DEFAULT or MAXVALUE partition, see [Section 13.4](#_Handling_Stray_Values_11).
...
Query the following Oracle-compatible catalog views to review detailed information about your partitioned tables.
