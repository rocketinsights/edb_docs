...
Tables are grouped into *databases*, and a collection of databases managed by a single Postgres Plus Advanced Server instance constitutes a database *cluster*.
...
The previous section discussed the basics of using SQL to store and access your data in Postgres Plus Advanced Server. This section discusses more advanced SQL features that may simplify management and prevent loss or corruption of your data.
...
<span id="_Synonyms_1" class="anchor"></span>
