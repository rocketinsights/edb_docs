...
> source /opt/PostgresPlus/9.4AS/pgplus\_env.sh

On Windows:

> C:\\Progra\~1\\PostgresPlus\\9.4AS\\pgplus\_env.bat
...
>
> export EDBHOME=/opt/PostgresPlus/9.4AS
>
...
> export PGPORT=5444
>
> export PGLOCALEDIR=/opt/PostgresPlus/9.4AS/share/locale

As the pgplus\_env.bat script executes (on Windows), it sets the following environment variables:

> PATH="C:\\Program Files\\PostgresPlus\\9.4AS\\bin";%PATH%
>
> EDBHOME=C:\\Program Files\\PostgresPlus\\9.4AS
>
> PGDATA=C:\\Program Files\\PostgresPlus\\9.4AS\\data
>
> PGDATABASE=edb
>
> PGUSER=enterprisedb
...
> PGPORT=5444
>
> PGLOCALEDIR=C:\\Program Files\\PostgresPlus\\9.4AS\\share\\locale
...
> On Linux:
>
> source /opt/PostgreSQL/9.4/pg\_env.sh
>
> On Windows:
>
> C:\\Progra\~1\\PostgreSQL\\9.4\\pg\_env.bat

As the pg\_env.sh script executes (on Linux), it sets the following environment variables:

> PATH=/home/opt/PostgreSQL/9.4/bin:$PATH
>
> PGDATA=/home/opt/PostgreSQL/9.4/data
>
> PGDATABASE=postgres
>
> PGUSER=postgres
...
> PGPORT=5432
>
> PGLOCALEDIR=/home/opt/PostgreSQL/9.4/share/locale
>
> MANPATH=$MANPATH:/home/opt/PostgreSQL/9.4/share/man
...
> PGPORT=5432
>
> PGLOCALEDIR=C:\\Program Files\\PostgreSQL\\9.4\\share\\locale

## Connecting to Advanced Server

After creating a startup database, starting the server, and modifying the pg\_hba.conf file (if necessary), you can connect to the server with the psql client (see Figure 6.4). psql is an Advanced Server client that allows you to query the server, and review the query results. Please note that additional configuration steps are required before connecting to an Oracle or MySQL database.

**Connecting to the Database with the psql Client**

If you have used a package manager to install Advanced Server and the psql client, use su - to assume the database superuser identity (enterprisedb):
...
Please note that the psql client must be in your search path.

If you have performed an installation with the interactive installer, you can easily access the psql client through the Applications or Start menu. Navigate through the Postgres Plus Advanced Server 9.4 menu to the Run SQL Command Line menu, and select EDB-PSQL. When the Terminal window opens, provide connection information for your session.

For more information about using the command line client, please refer to the documentation at:

<http://www.enterprisedb.com/docs/en/9.4/pg/app-psql.html>
