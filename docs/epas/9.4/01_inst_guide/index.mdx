...
The Postgres Plus Advanced Server Installation Guide is a comprehensive guide to installing Advanced Server. In this guide you will find detailed information about:
 - Software prerequisites for Advanced Server 9.4
 ...
 - Using pg\_upgrade to upgrade from an earlier version of Advanced Server to Advanced Server 9.4
