...
The Advanced Server interactive installer creates uninstallers that you can use to remove Postgres Plus Advanced Server or any of its individual components. If you uninstall an Advanced Server component, the remainder of the Advanced Server installation will remain intact.
...
> rpm -i ppas94-9.4.*x*.*x*.rhel6.rpm
...
> yum install ppas94-9.4.*x*.*x*.rhel6.rpm
...
| ------------------------------------------ | ------------------------------ | ---------------------------------- |
| The Database Server                        | uninstall-db\_server           | /opt/PostgresPlus/9.4AS            |
| Advanced Server and all supporting modules | uninstall-ppas\_9\_4\_complete | /opt/PostgresPlus                  |
...
| PgPool                                     | uninstall-pgpool               | /opt/PostgresPlus/pgpool-II        |
| PgPool Extension                           | uninstall-pgpool\_extension    | /opt/PostgresPlus/9.4AS            |
...
A dialog opens, asking you to confirm your decision to uninstall Postgres Plus Advanced Server (see Figure 9.1)
...
You can use the graphical interface provided by Windows to uninstall Postgres Plus Advanced Server 9.4. Navigate through the Windows Control Panel to open the Windows Uninstall or change a program dialog (shown in Figure 9.4).

![](./images/image96.png)

*Figure 9.4 — The Programs and Features dialog.*

Right click on Postgres Plus Advanced Server 9.4 or the component you wish to uninstall, and select Uninstall/Change from the context menu.

Select Postgres Plus Advanced Server 9.4 (Complete) to uninstall Advanced Server and the supporting Advanced Server components. If you are removing both the server and its supporting modules, a popup (shown in Figure 9.5) will prompt you to confirm that you wish to remove Advanced Server and its supporting components.

![](./images/image97.png)

*Figure 9.5 — A dialog asks you to confirm that you wish to remove the server and its components.*

Select Postgres Plus Advanced Server 9.4 to uninstall only the Advanced Server database server. A system restart may be required to complete the removal of some Advanced Server components; if prompted, click OK to continue.
