...
> Any of the hints in table

[Access Method Hints](access_method_hints),
...
A view named, `tx`, is created from the three-table join of `pgbench_history, pgbench_branches`, and `pgbench_accounts` shown in the final example of [Joining Relations Hints](joining_relations_hints).
...
The same hints that were applied to this join at the end of [Joining Relations Hints](joining_relations_hints) can be applied to the view as follows:
