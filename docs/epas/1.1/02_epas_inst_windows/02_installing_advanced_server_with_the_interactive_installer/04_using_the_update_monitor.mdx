...
Click `Install components` to open StackBuilder Plus, and check for component updates. See [Using StackBuilder Plus](using_stackbuilder_plus) for detailed information about the update process.
