...
Configuration parameters that apply only to Advanced Server are noted in the [Summary of Configuration Parameters](summary_of_configuration_parameters) section.
