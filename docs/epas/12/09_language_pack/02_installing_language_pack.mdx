...
The graphical installer is available from the [EDB website](https://www.enterprisedb.com/edb-docs), as well as via Stack Builder and StackBuilder Plus.
...
![*The Language Selection Window*](images/lp1.png)

The installer `Welcome` window opens.

![*The Language Pack Welcome Window*](images/lp_aug6.png)
...
![*The Language Pack Setup Complete dialog*](images/lp4_aug6.png)
...
![*The Stack Builder Welcome Window*](images/sb_aug6.png)

Expand the `Add-ons, tools and utilities` node of the `Categories` tree control, and check the box next to `EDB Language Pack v1.0-4`. Click `Next` to continue.

![*The Language Pack Selection Window*](images/sb2_aug6.png)

Stack Builder will confirm your package selection before downloading the installer. Click `Next` to continue.

> ![*The Selected Packages Window*](images/sb3_aug6.png)

When the download completes, Stack Builder will offer to invoke the installer for you, or will delay the installation until a more convenient time.

For details about using the graphical installer, see [Invoking the Graphical Installer](#invoking_the_graphical_installer).
