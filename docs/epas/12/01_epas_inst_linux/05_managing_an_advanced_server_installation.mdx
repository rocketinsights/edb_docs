...
| ------------------------------ | ------------------------ | -------------------------- |
| Advanced Server                | edb-as-13                | edb-as13-main              |
...
> 
> ``` text
> /usr/bin/epas_ctlcluster 13 main status
> ```
...
> 
> ``` text
> /usr/bin/epas_ctlcluster 13 main stop
> ```
...
> 
> ``` text
> /usr/bin/epas_ctlcluster 13 main restart
> ```
...
> 
> ``` text
> /usr/bin/epas_ctlcluster 13 main reload
> ```
