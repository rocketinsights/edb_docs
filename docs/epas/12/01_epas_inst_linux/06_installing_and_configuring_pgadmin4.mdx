...
You can install EDB pgAdmin 4 for your Advanced Server database using the `yum` package manager for RHEL/CentOS 6.x and 7.x platform and using `dnf` package manager for RHEL/CentOS 8.x platform.
