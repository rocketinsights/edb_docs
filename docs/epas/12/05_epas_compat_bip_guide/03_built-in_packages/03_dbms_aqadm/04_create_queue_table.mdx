...
> 
> ``` text
> TABLESPACE tablespace_name, PCTFREE integer, PCTUSED integer, INITRANS
> integer, MAXTRANS integer or STORAGE storage_option.
> ```
> 
...
> size_clause, NEXT, FREELISTS integer, OPTIMAL size_clause, BUFFER_POOL
