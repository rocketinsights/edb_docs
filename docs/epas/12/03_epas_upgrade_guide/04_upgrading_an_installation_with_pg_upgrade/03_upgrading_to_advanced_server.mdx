...
If a problem occurs during the upgrade process, you can revert to the previous version. See [Reverting to the old cluster](../04_upgrading_an_installation_with_pg_upgrade/#reverting_to_the_old_cluster) Section for detailed information about this process.
