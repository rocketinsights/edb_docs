...
declaring_a_cursor opening_a_cursor fetching_rows_from_a_cursor closing_a_cursor [using]()%_rowtype_with_cursors cursor_attributes cursor_for_loop parameterized_cursors
