...
The rules for invoking subprograms based upon block location is described starting with [Invoking Subprograms](../../02_spl_programs/07_subprograms_subprocedures_and_subfunctions/#invoking_subprograms). The rules for accessing variables based upon block location is described in [Accessing Subprogram Variables](../../02_spl_programs/07_subprograms_subprocedures_and_subfunctions/#accessing_subprogram_variables).
