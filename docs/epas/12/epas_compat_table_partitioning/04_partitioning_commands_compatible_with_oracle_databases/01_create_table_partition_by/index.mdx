...
For more information about `AUTOMATIC LIST PARTITIONING`, see [Automatic List Partitioning](../02_selecting_a_partition_type/#automatic_list_partitioning).
...
For more information about `INTERVAL RANGE PARTITION`, see [Interval Range Partitioning](../02_selecting_a_partition_type/#interval_range_partitioning).
...
> </div>
> 
> You can either use `PARTITIONS` or `PARTITION DEFINITION` when creating a table.
> 
> </div>
> 
