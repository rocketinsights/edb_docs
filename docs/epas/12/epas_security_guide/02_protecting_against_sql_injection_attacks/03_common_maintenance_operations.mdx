...
The statistics for a role that has been removed are not deleted until you use the <span class="title-ref">drop_stats function \<drop_stats\></span>.

The offending queries for a role that has been removed are not deleted until you use the <span class="title-ref">drop_queries function \<drop_queries\></span>.
