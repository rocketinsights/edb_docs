...
Before installing Advanced Server and EDB Replicate, assume superuser privileges and use yum to install prerequisite packages:
...
**Step 5:** Use sudo to assume the identity of the `enterprisedb` database superuser and create an Advanced Server cluster named `acttg` on listener port `5444`:
...
You can use simple SQL commands to query the database and retrieve information about the data you've added to the table:
...
For more detailed product usage information, please see the [Advanced Server documentation, available at the EnterpriseDB website](https://www.enterprisedb.com/edb-docs/).
