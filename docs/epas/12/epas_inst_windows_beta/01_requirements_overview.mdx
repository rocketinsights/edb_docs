...
**Migration Toolkit Installation Pre-requisites**

Before using a StackBuilder Plus to install Migration Toolkit, you must first install Java (version 1.8 or later). If you are using Windows, Java installers and instructions are available online at:
