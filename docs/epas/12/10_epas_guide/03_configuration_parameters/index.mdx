...
Configuration parameters that apply only to Advanced Server are noted in the [Summary of Configuration Parameters](03_configuration_parameters/02_summary_of_configuration_parameters#summary_of_configuration_parameters) section.
