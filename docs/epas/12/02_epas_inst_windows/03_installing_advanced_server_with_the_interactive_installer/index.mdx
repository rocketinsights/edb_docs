...
You can invoke the graphical installer in different installation modes to perform an Advanced Server installation:
  ...
  - For information about using the graphical installer, see [Performing a Graphical Installation on Windows](03_installing_advanced_server_with_the_interactive_installer/#performing_a_graphical_installation_on_windows).
  - For information about performing an unattended installation, see [Performing an Unattended Installation](03_installing_advanced_server_with_the_interactive_installer/02_invoking_the_graphical_installer_from_the_command_line/#performing_an_unattended_installation).
  - For information about performing an installation with limited privileges, see [Performing an Installation with Limited Privileges](03_installing_advanced_server_with_the_interactive_installer/02_invoking_the_graphical_installer_from_the_command_line/#performing_an_installation_with_limited_privileges).
  - For information about the command line options you can include when invoking the installer, see [Reference - Command Line Options](03_installing_advanced_server_with_the_interactive_installer/02_invoking_the_graphical_installer_from_the_command_line/#reference_command_line_options).
...
performing_a_graphical_installation_on_windows invoking_the_graphical_installer_from_the_command_line using_stackbuilder_plus using_the_update_monitor installation_troubleshooting
