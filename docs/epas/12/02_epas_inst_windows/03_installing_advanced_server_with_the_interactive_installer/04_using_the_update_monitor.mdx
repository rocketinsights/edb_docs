...
Click `Install components` to open StackBuilder Plus, and check for component updates. See [Using StackBuilder Plus](../03_installing_advanced_server_with_the_interactive_installer/#using_stackbuilder_plus) for detailed information about the update process.
