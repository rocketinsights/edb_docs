...
performing_an_upgrade invoking_pg_upgrade upgrading_to_advanced_server12 upgrading_a_pgAgent_installation pg_upgrade_troubleshooting reverting_to_the_old_cluster
