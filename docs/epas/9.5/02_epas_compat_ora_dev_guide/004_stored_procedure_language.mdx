...
**Note:** The syntax for calling a procedure is the same as in the preceding syntax diagram when executing it with the EXEC command in PSQL or EDB\*Plus. See Section <span class="underline">11.1.2.12</span> for information about the EXEC command.
