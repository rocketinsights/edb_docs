...
dblink\_ora provides an OCI-based database link that allows you SELECT, INSERT, UPDATE or DELETE data stored on an Oracle system from within Advanced Server.
