...
<http://www.postgresql.org/docs/9.5/static/sql-reindex.html>ALTER INDEX has no effect on stored data.
...
For more information about Profile Management, see Section <span class="underline">2.3</span>.
...
Sets the default optimization mode for queries. Valid values are ALL\_ROWS, CHOOSE, FIRST\_ROWS, FIRST\_ROWS\_10, FIRST\_ROWS\_100, and FIRST\_ROWS\_1000. The default is CHOOSE. This parameter is implemented in Advanced Server. See [Section 3.4](#_Optimizer_Hints) for more information about optimizer hints.
...
<http://www.postgresql.org/docs/9.5/static/sql-commands.html>Only a database superuser can use the ALTER USER|ROLE clauses that enforce profile management. The clauses enforce the following behaviors:
...
These clauses are implemented to support Oracle-styled profile management. For more information about Profile Management, see Section <span class="underline">2.3</span>.
...
The user that creates the procedure becomes the owner of the procedure. See Section <span class="underline"></span>4.2.3 for more information about procedures.
...
A synonym is an alternate name that refers to a database object. See Section <span class="underline">2.2.4</span> for additional information about synonyms.
...
The data type of the column. This may include array specifiers. For more information on the data types included with Advanced Server, refer to Section <span class="underline">3.2</span>.
...
The ALTER ROLE syntax is functionally equivalent to the respective commands compatible with Oracle databases. For more information about using the ALTER ROLE command to manage database link privileges, see [Section 3.3.3](#_ALTER_ROLE), ALTER ROLE.
...
Please Note: The Advanced Server ALTER ROLE command also supports syntax that revokes the system privileges required to create a public or private database link, or exemptions from fine-grained access control policies (DBMS\_RLS). The ALTER ROLE syntax is functionally equivalent to the respective REVOKE command, compatible with Oracle databases. For more information about using the ALTER ROLE command to manage system privileges, see [Section 3.3.3](#_ALTER_ROLE), ALTER ROLE.
...
ROLLUP, CUBE, and GROUPING SETS are extensions to the GROUP BY clause for supporting multidimensional analysis. See Section <span class="underline"></span>3.3.65.3 for information on using these extensions.
...
<td>DATE</td>
<td>Add months to a date; see Section <span class="underline">3.5.8.1</span></td>
...
<td>CURRENT_DATE</td>
<td>DATE</td>
<td>Current date; see Section <span class="underline"> </span> <span class="underline">3.5.8.8</span></td>
<td>CURRENT_DATE</td>
<td>04-JUL-07</td>
</tr>
<tr class="even">
...
<td>TIMESTAMP</td>
<td>Returns the current date and time; see Section <span class="underline">3.5.8.8</span></td>
<td>CURRENT_TIMESTAMP</td>
...
<td>DOUBLE PRECISION</td>
<td>Get subfield; see Section <span class="underline">3.5.8.2</span></td>
...
<td>TIMESTAMP</td>
<td>Current date and time (start of current transaction); see Section <span class="underline">3.5.8.8</span></td>
...
<td>NUMBER</td>
<td>Number of months between two dates; see Section <span class="underline">3.5.8.3</span></td>
...
<td>DATE</td>
<td>Date falling on <em>dayofweek</em> following specified date; see Section <span class="underline"> </span> <span class="underline">3.5.8.4</span></td>
...
<td>INTERVAL</td>
<td>Converts a number to a specified day or second interval; see Section <span class="underline">3.5.8.9</span>.</td>
...
<td>INTERVAL</td>
<td>Converts a number to a specified year or month interval; see Section <span class="underline">3.5.8.10</span>.</td>
...
<td>DATE</td>
<td>Date rounded according to <em>format</em>; see Section <span class="underline">3.5.8.6</span></td>
...
<td>DATE</td>
<td>Truncate according to format; see Section <span class="underline">3.5.8.7</span></td>
