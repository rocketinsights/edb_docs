...
For more information about the DBMS\_PROFILER built-in package (including usage examples and a reference guide to the DBMS\_PROFILER tables and views), see the Advanced Server Performance Features Guide.
...
Once policies are created, they can be viewed in the catalog views, compatible with Oracle databases: ALL\_POLICIES (see Section <span class="underline">10.11</span>), DBA\_POLICIES (see Section <span class="underline">10.35</span>), or USER\_POLICIES (see Section <span class="underline">10.62</span>).
...
The UTL\_FILE package reports the following exception codes compatible with Oracle databases:
...
See Section <span class="underline">7.21.2</span> for a description of REPLY and REPLIES.
...
SMTP reply lines to the command. See Section <span class="underline">7.21.2</span> for a description of REPLY and REPLIES.
...
SMTP reply to the command. If SMTP returns multiple replies, only the last one is returned in *reply*. See Section <span class="underline">7.21.2</span> for a description of REPLY and REPLIES.
