...
CDS support is offered in two levels; [Basic Support and Enterprise Support](support_comparison). Use the `Enterprise Support` slider to enable Enterprise Support.

Enterprise support includes 24 x 7 access to Postgres Rocks, an initial response to support issues in 30 minutes, and performance tuning guidance.
