...
When you select a region, the [Ark user console ](09_cds_user_cluster_tab#cds_user_cluster_tab) will open in a new browser tab. The CDS management console will remain available in your current tab, allowing you to perform management tasks related to the account.

Tabs on the CDS web interface allow you to manage your CDS account. Tab access is controlled by administrator-assigned membership in a [Team ](04_cds_mgmt_teams_users#cds_mgmt_teams_users).
