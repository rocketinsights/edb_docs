...
metaTitle: Encrypting Your Database Password
metaDescription: description
---

Failover Manager requires you to encrypt your database password before
including it in the cluster properties file. Use the [efm
utility](efm_encrypt)
...
Where `<cluster_name>` specifies the name of the Failover Manager
cluster.

If you include the `--from-env` option, you must export the value you
wish to encrypt before invoking the encryption utility. For example:
...
``` text
---
title: efm encrypt acctg
metaTitle: efm encrypt acctg
metaDescription: description
---
...
``` text
---
title: efm encrypt acctg --from-env
metaTitle: efm encrypt acctg --from-env
metaDescription: description
---
---
title: 7ceecd8965fa7a5c330eaa9e43696f83
metaTitle: 7ceecd8965fa7a5c330eaa9e43696f83
metaDescription: description
---
```

The encrypted password (`7ceecd8965fa7a5c330eaa9e43696f83`) is returned
as a text value; when using a script, you can check the exit code of the
