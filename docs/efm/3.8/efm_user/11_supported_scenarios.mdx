...
<figure><img src="images/supported_scenarios_master_db_down.png" class="align-center" alt="Confirming the Failure of the Master Database." /><figcaption aria-hidden="true"><em>Confirming the Failure of the Master Database.</em></figcaption></figure>
...
<figure><img src="images/supported_scenarios_master_agent_exits.png" class="align-center" alt="Confirming the failure of the Master Agent." /><figcaption aria-hidden="true"><em>Confirming the failure of the Master Agent.</em></figcaption></figure>
