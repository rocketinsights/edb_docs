...
The efm cluster-status [cluster properties file](#efm_cluster_status) command returns a report that contains information about the status of the Failover Manager cluster. To invoke the command, enter:

> `# efm cluster-status <cluster_name>`

The following status report is for a cluster named `efm` that has four nodes running:

    [root@one ~]# efm cluster-status efm
    Cluster Status: efm

     Agent Type  Address              Agent  DB       VIP
     -----------------------------------------------------------------------
     Master      172.16.144.137       UP     UP        
     Standby     172.16.144.138       UP     UP       172.19.13.107* 
     Standby     172.16.144.139       UP     UP       172.19.13.106 
     Standby     172.16.144.140       UP     UP       172.19.13.108 

    Allowed node host list:
     172.16.144.137 172.16.144.138 172.16.144.139 172.16.144.140

    Membership coordinator: 172.16.144.137

    Standby priority host list:
     172.16.144.138 172.16.144.139

    Promote Status:

      DB Type     Address              WAL Received LSN   WAL Replayed LSN   Info
     ---------------------------------------------------------------------------
     Master      172.16.144.137                          0/15002480         
     Standby     172.16.144.138       0/15002480         0/15002480         
     Standby     172.16.144.139       0/15002480         0/15002480         
     Standby     172.16.144.140       0/15002480         0/15002480         
...
<figure><img src="images/str_replication_dashboard_master.png" class="align-center" alt="The Streaming Replication dashboard (Master node)" /><figcaption aria-hidden="true"><em>The Streaming Replication dashboard (Master node)</em></figcaption></figure>
...
<figure><img src="images/str_replication_dashboard_standby.png" class="align-center" alt="The Streaming Replication dashboard (Standby node)" /><figcaption aria-hidden="true"><em>The Streaming Replication dashboard (Standby node)</em></figcaption></figure>
