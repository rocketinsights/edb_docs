...
<figure><img src="images/cascading_replication.png" class="align-center" alt="Cascading replication." /><figcaption aria-hidden="true"><em>Cascading replication.</em></figcaption></figure>
