\<div id="appendix" class="registered\_link"\>\</div\>
...
\<div id="load\_balancer\_detach\_sh" class="registered\_link"\>\</div\>
...
\<div id="load\_balancer\_attach\_sh" class="registered\_link"\>\</div\>
