...
Create the [encrypted password](https://www.enterprisedb.com/edb-docs/d/edb-postgres-failover-manager/user-guides/user-guide/3.10/encrypting_database_password.html) needed for the properties file:
