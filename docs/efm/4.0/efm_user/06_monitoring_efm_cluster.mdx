...
The efm cluster-status [cluster properties file](#efm_cluster_status) command returns a report that contains information about the status of the cluster. To invoke the command, enter:
...
<figure><img src="images/str_replication_dashboard_master.png" class="align-center" alt="The Streaming Replication dashboard (Primary node)" /><figcaption aria-hidden="true"><em>The Streaming Replication dashboard (Primary node)</em></figcaption></figure>
