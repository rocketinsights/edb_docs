\<div id="block-level\_incremental\_backup" class="registered\_link"\>\</div\>
...
Generally, all BART features (such as retention policy management) apply to incremental backups and full backups. See [Managing Incremental Backups](#managing_incremental_backups) for information.
