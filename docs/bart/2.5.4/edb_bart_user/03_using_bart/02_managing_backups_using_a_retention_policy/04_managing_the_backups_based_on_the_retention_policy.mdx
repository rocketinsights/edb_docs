...
This section covers following aspects of backup management:
  ...
  - The process to retain a backup indefinitely by [marking it as keep](#marking_backups_for_indefinite_keep_status). This section also provides information about resetting backups status (that are marked as `obsolete` and `keep`) back to active status.
...
\<div id="deletions\_permitted\_under\_retention\_policy" class="registered\_link"\>\</div\>
...
<tr class="odd">
<td>Operation</td>
<td>Redundancy Retention Policy</td>
<td></td>
<td></td>
<td>Recovery Window Retention Po</td>
<td>licy</td>
<td></td>
</tr>
<tr class="even">
...
<tr class="even">
<td>DELETE –i <em>backup</em></td>
<td><p>Yes</p>
<p>(see <a href="###note1">Note1</a>_)</p></td>
<td><blockquote>
<p>Yes</p>
</blockquote>
<div class="line-block">(see <a href="###note1">Note1</a>_)</div></td>
<td><p>Yes</p>
<div class="line-block"> (see <a href="###note1">Note1</a>_)</div></td>
<td><p>Yes</p>
<blockquote>
<div class="line-block">(see <a href="###note2">Note2</a></div>
</blockquote></td>
<td><blockquote>
<p>Yes</p>
</blockquote>
_) | (see <a href="###note2">Note2</a>_)</td>
<td><p>Yes</p>
<blockquote>
<div class="line-block">(see <a href="###note2">Note2</a>_)</div>
</blockquote></td>
</tr>
<tr class="odd">
<td>DELETE –i all</td>
...
\<div id="note1" class="registered\_link"\>\</div\>
...
\<div id="note2" class="registered\_link"\>\</div\>
...
\<div id="marking\_backups\_for\_indefinite\_keep\_status" class="registered\_link"\>\</div\>
...
\<div id="evaluating\_marking\_and\_deleting\_obsolete\_backups" class="registered\_link"\>\</div\>
...
The status of backups currently marked as `obsolete` or `keep` is not changed. To re-evaluate such backups and then classify them, their status must first be reset to `active` with the `MANAGE -c nokeep` option. See [Marking the Backup Status](#marking_the_backup_status) for more information.
