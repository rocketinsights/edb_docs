\<div id="backup" class="registered\_link"\>\</div\>
...
To take an [incremental backup](#block-level_incremental_backup), you must take a full backup first followed by incremental backup.
...
\<div id="backup\_name\_examples" class="registered\_link"\>\</div\>
...
BACKUP Subcommand Error Messages
