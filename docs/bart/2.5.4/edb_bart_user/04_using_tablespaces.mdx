\<div id="using\_tablespaces" class="registered\_link"\>\</div\>
...
To view example of backing up and restoring a database cluster on a remote host containing tablespaces, see the [EDB Postgres Backup and Recovery Reference Guide](https://www.enterprisedb.com/edb-docs/).
