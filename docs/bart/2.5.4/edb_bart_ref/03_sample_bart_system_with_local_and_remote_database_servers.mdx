\<div id="a\_sample\_bart\_system\_with\_local\_and\_remote\_database\_servers" class="registered\_link"\>\</div\>
...
\<div id="bart\_configuration\_file" class="registered\_link"\>\</div\>
...
\<div id="establishing\_ssh\_scp\_passwordless\_connections" class="registered\_link"\>\</div\>
...
\<div id="generating\_a\_public\_key\_file\_for\_the\_bart\_user\_account" class="registered\_link"\>\</div\>
...
\<div id="configuring\_a\_replication\_database\_user" class="registered\_link"\>\</div\>
...
\<div id="wal\_archiving\_configuration\_parameters" class="registered\_link"\>\</div\>
...
If the Postgres `archive_command` is already set, invoke the `INIT` subcommand with the `-- no-configure` option to prevent the `archive_command` from being reset. For details, see [INIT](#init).
...
\<div id="creating\_the\_bart\_backup\_catalog\_backup\_path" class="registered\_link"\>\</div\>
...
Before invoking any BART subcommands, set up a profile under the BART user account’s home directory to set the `LD_LIBRARY_PATH` and `PATH` environment variables. For more information regarding setting this variable, see the [EDB Postgres Backup and Recovery Installation and Upgrade Guide](https://www.enterprisedb.com/edb-docs/).
...
\<div id="starting\_the\_database\_servers\_with\_wal\_archiving" class="registered\_link"\>\</div\>
...
\<div id="using\_point-in-time\_recovery" class="registered\_link"\>\</div\>
