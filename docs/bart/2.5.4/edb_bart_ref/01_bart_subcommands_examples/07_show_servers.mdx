...
<table><thead><tr class="header"><th>Option</th><th>Description</th></tr></thead><tbody><tr class="odd"><td><code>-s</code> or <code>--server { &lt;server_name&gt; | all</code> }</td><td><p><code>&lt;server_name&gt;</code> is the name of the database server to which the <code>SHOW-SERVERS</code> actions are to be applied.<br />
