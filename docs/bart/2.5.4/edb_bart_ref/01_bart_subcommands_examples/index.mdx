\<div id="using\_bart\_subcommands" class="registered\_link"\>\</div\>
...
backup check\_config delete init manage restore show\_servers show\_backups verify\_chksum running\_the\_bart\_wal\_scanner
