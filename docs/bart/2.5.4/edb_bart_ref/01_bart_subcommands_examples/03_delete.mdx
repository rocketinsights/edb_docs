...
For database servers under a retention policy, there are conditions where certain backups may not be deleted. For more information, see the [EDB Postgres Backup and Recovery User Guide](https://www.enterprisedb.com/edb-docs/).
