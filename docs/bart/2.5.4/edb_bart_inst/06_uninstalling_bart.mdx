\<div id="uninstallation" class="registered\_link"\>\</div\>
...
For information about the BART `DELETE` subcommand, refer the EDB Postgres Backup and Recovery User Guide [available at this page](https://www.enterprisedb.com/edb-docs/).
