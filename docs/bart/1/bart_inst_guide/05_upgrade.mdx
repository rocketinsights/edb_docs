...
This section outlines the process of upgrading BART from an existing version to the latest version.
  ...
  - [Upgrading from BART 2.0  ](05_upgrade#upgrading_from_bart_2.0) describes the upgrade process from BART 2.0 to the latest version.
  - [Upgrading from BART older versions ](05_upgrade#upgrading_from_older_versions_except_2.0_to_latest_versions_of_bart) describes the upgrade process from previous BART versions (except 2.0) to the latest version.
...
<div id="upgrading_from_older_versions_except_2.0_to_latest_versions_of_bart" class="registered_link"></div>
