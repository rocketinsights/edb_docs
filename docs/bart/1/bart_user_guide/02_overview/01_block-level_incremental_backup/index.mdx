...
Generally, all BART features (such as retention policy management) apply to incremental backups as well as full backups. See [Managing Incremental Backups ](../03_using_bart/02_managing_backups_using_a_retention_policy/05_managing_incremental_backups#managing_incremental_backups) for information about retention policy management as applied to incremental backups.
