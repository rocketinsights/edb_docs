...
A detailed description of the `RESTORE` subcommand is available in the [Basic Bart Subcommand Usage](../../03_using_bart/03_basic_bart_subcommand_usage/index#basic_bart_subcommand_usage) section.
