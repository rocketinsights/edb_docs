...
The `SHOW-BACKUPS` subcommand displays the backup information for the managed database servers. To view examples of `SHOW-BACKUPS` subcommand, see the *EDB Postgres Backup and Recovery Reference Guide* available at:
...
> Displays more backup information in a list format. If the option is omitted, the default is a tabular format.
