...
The `SHOW-SERVERS` subcommand displays the information for the managed database servers listed in the BART configuration file. To view examples of `SHOW-SERVERS` subcommand, see the *EDB Postgres Backup and Recovery Reference Guide* available at:
