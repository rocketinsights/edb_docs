...
project = 'EDB Postgres™ Backup and Recovery User Guide'
copyright = '2019, EnterpriseDB'
author = 'EnterpriseDB'
...
latex_elements = {
    ...
    #'fncychap' : r'\usepackage{longtable}',
...
latex_documents = [
    (master_doc, 'EDB_Postgres_Backup_and_Recovery_User_Guide.tex', 'EDB Postgres™ Backup and Recovery User Guide',
     'EDB Postgres™ Backup and Recovery User Guide', 'manual'),
]
