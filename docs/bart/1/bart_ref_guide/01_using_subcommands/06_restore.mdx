...
<tr class="odd">
<td><p>ppas-9.5.service</p>
<p>ppas-9.5.sh</p></td>
<td>/usr/lib/systemd/system</td>
<td>Service unit file and script for Advanced Server 9.5 from interactive installer</td>
</tr>
<tr class="even">
<td><p>edb-as-9.6.service</p>
<p>edb-as-9.6.sh</p></td>
<td>/usr/lib/systemd/system</td>
<td>Service unit file and script for Advanced Server 9.6 from interactive installer</td>
</tr>
<tr class="odd">
<td><p>edb-as-10.service</p>
<p>edb-as-10.sh</p></td>
<td>/usr/lib/systemd/system</td>
<td>Service unit file and script for Advanced Server 10 from interactive installer</td>
</tr>
<tr class="even">
<td>edb-as-11</td>
<td>/usr/lib/systemd/system</td>
<td>Service unit file and script for Advanced Server 11 from interactive installer</td>
</tr>
<tr class="odd">
<td><p>ppas-9.5.service</p>
<p>ppas-9.5.sh</p></td>
<td>/usr/lib/systemd/system</td>
<td>Service unit file and script for Advanced Server 9.5 from RPM package</td>
</tr>
<tr class="even">
