...
\- [Using a Recovery Window Retention Policy](recovery_window_retention_policy) provides

> an example of using the `MANAGE` and `DELETE` subcommands when a 1-day recovery window retention policy is in effect.
