...
**Step 1** Assume superuser privileges and install the _Extra Packages for Enterprise Linux (EPEL)_ package by invoking the following command:
...
- The remote user account on the remote host to which incremental backups are to be restored. For details, see the _Restoring an Incremental Backup on a Remote Host_ Section of the _EDB Postgres Backup and Recovery User Guide_ available at:
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr class="even">
        ...
        <td>
          <code>&lt;BART_HOME&gt;/bin</code>
        </td>
        <td>BART command line, executable program</td>
      </tr>
      <tr class="odd">
        <td>
          <code>bart-scanner</code>
        </td>
        <td>
          <code>&lt;BART_HOME&gt;/bin</code>
        </td>
      ...
      <tr class="even">
        <td>
          <code>bart.cfg.sample</code>
        </td>
        <td>
          <code>&lt;BART_HOME&gt;/etc</code>
        </td>
        <td>Sample BART configuration file</td>
      </tr>
      <tr class="odd">
        <td>
          <code>xlogreader_ident.so</code>
        </td>
        <td>
          <code>&lt;BART_HOME&gt;/lib</code>
        </td>
        <td>Libraries supporting WAL versions</td>
      </tr>
      <tr class="even">
        <td>
          <code>bart_license.txt</code>
        </td>
        <td>
          <code>&lt;BART_HOME&gt;</code>
        </td>
