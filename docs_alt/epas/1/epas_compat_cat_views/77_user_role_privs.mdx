...
metaTitle: USER_ROLE_PRIVS
metaDescription: description
---

The `USER_ROLE_PRIVS` view provides information about the privileges
that have been granted to the current user. A row is created for each
role to which a user has been granted.
