...
project = 'Advanced Server Windows Installation Guide'
...
latex_documents = [
    (master_doc, 'postgres_advanced_server_installation_guide_windows.tex', 'EDB Postgres™ Advanced Server Installation Guide for Windows',
...
#     'EnterpriseDB Documentation Documentation',
#     [author], 1)
# ]
