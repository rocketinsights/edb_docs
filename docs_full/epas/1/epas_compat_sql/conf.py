...
latex_documents = [
    (master_doc, 'Database_Compatibility_for_Oracle_Developers_SQL_Guide.tex', 'EDB Postgres™ Advanced Server',
     'Database Compatibility for Oracle Developers SQL Guide', 'manual'),
]
