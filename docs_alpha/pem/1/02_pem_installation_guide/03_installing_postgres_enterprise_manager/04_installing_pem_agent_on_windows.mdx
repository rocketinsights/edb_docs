...
![*The PEM Agent Installer's Welcome dialog*](../images/pem_agent_welcome_dialog.png)

Click `Next` to continue to the `License Agreement`.

![*The PEM License Agreement*](../images/pem_agent_windows_license_agreement.png)
...
![*Specify an Installation Directory*](../images/pem_agent_windows_installation_directory.png)
...
![*Provide PEM server installation details*](../images/pem_agent_pem_server_windows_installation_details.png)
...
![*pemAgent Service Account password*](../images/pem_agent_service_account_windows_password.png)
...
![*Specify a descriptive name for the PEM agent*](../images/pem_agent_windows_agent_details.png)
...
![*The PEM Agent installation is ready to begin*](../images/pem_agent_windows_installation_ready_to_begin.png)
...
![*Progress bars mark the installation's progress*](../images/pem_agent_windows_installation_in_progress.png)

The PEM agent installer displays progress bars to mark the PEM agent's installation progress.

![*The PEM Agent installation is complete*](../images/pem_agent_windows_installation_complete.png)
