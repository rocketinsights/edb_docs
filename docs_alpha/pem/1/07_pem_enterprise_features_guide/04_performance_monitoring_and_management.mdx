...
![*Specifying placement details for a chart*](images/specify_placement_details.png)
...
![*Specifying general information about the chart*](images/chart_general_info.png)
...
![*Specifying the metrics that will be displayed*](images/chart_select_metrics.png)
...
![*The chart definition is displayed on the Manage Charts tab*](images/manage_charts_tab1.png)
...
![*Importing a Capacity Manager template*](images/import_capacity_manager_template.png)
...
![*Selecting permissions for the chart*](images/chart_access_permission.png)
...
![*Defining a custom probe – the General tab*](images/custom_probe_general.png)
...
![*The Columns tab of the Custom Probes dialog*](images/custom_probe_columns.png)
...
![*The Code tab of the Custom Probes dialog*](images/custom_probe_code.png)
...
![*The Alternate Code tab of the Custom Probes dialog*](images/custom_probe_altenate_code.png)
...
![*The Copy Probe Configuration tree control*](images/copy_probe_configuration.png)
...
![*The Probe Dependency tab of the Alert Templates dialog*](images/alert_template_probe_dependency.png)
...
![*The Parameters tab of the Alert Templates dialog*](images/alert_template_parameters.png)
...
![*The General tab of the alert editor*](images/alert_editor_general.png)
...
![*The alert editor Notification tab*](images/alert_editor_notification.png)
...
![*The Copy Alert Configuration dialog*](images/copy_alert_configuration.png)
