...
![*The Failover Manager cluster status report*](images/failover_manager_cluster_status_report.png)
...
![*Replacing the Master node of a cluster*](images/replace_master_node_of_cluster.png)
