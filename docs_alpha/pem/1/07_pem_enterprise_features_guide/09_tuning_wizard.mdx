...
![*The Tuning Changes Summary dialo*](images/tuning_wizard_tuning_changes_summary.png)
...
![*The Schedule or Run? dialog*](images/tuning_wizard_schedule_or_run.png)
...
![*The Schedule or Run? dialog*](images/tuning_wizard_schedule_or_run_1.png)
...
![*Confirming a change in the postgresql.conf file*](images/change_postgresql.png)
