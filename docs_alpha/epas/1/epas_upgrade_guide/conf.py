...
project = 'EDB Postgres™ Advanced Server Upgrade Guide'
...
latex_documents = [
    (master_doc, 'EDB_Postgres_Advanced_Server_Upgrade_Guide.tex', 'EDB Postgres Advanced Server Upgrade Guide',
     'EDB Postgres Advanced Server', 'manual'),
]
