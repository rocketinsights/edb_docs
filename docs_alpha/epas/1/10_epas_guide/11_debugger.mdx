...
Note that triggers cannot be debugged using standalone debugging. Triggers must be debugged using in-context debugging. See the [Setting Global Breakpoint for In-Context Debugging](setting_global_breakpoint_for_in_context_debugging) section

for information on setting a global breakpoint for in-context debugging.
...
<div id="setting_global_breakpoint_for_in_context_debugging">
