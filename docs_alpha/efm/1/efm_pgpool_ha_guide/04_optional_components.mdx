...
metaTitle: Optional Components
metaDescription: description
---

## Virtual IP Addresses

Both Pgpool-II and Failover Manager provide functionality to employ a
virtual IP for seamless failover. While both provide this capability, it
must be noted that Failover Manager associates a virtual IP to the
master database node while Pgpool associates a virtual IP to the
currently-active Pgpool host (in a multi-Pgpool watchdog setup).
...
wd_life_point = 3
---
title: virtual IP control
metaTitle: virtual IP control
metaDescription: description
---
if_cmdconfig_path = '/sbin' # ifconfig command path
if_up_cmd = 'ifconfig eth0:0 inet $_IP_$ netmask 255.255.255.0'
---
title: startup delegate IP command
metaTitle: startup delegate IP command
metaDescription: description
---
