...
See the *EDB Postgres Backup and Recovery Reference Guide* for examples of creating a backup chain and restoring an incremental backup. The reference guide is available at:
