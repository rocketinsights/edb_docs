...
Generally, all BART features (such as retention policy management) apply to incremental backups as well as full backups. See [Managing Incremental Backups](managing_incremental_backups) for information about retention policy management as applied to incremental backups.
