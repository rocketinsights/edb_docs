...
\- The process to retain a backup indefinitely by [marking it as keep](marking_backups_for_indefinite_keep_status). This section also provides information about
...
\+----------------------+-------------------------------+------------------------------------+------------------------------+----------------------------+-------------------------------+----------------------------+ | Operation | Redundancy Retention Policy | Recovery Window Retention Policy | +----------------------+-------------------------------+------------------------------------+------------------------------+----------------------------+-------------------------------+----------------------------+ | | Active | Obsolete | Keep | Active | Obsolete | Keep | +----------------------+-------------------------------+------------------------------------+------------------------------+----------------------------+-------------------------------+----------------------------+ | MANAGE –d | No | Yes | No | No | Yes | No | +----------------------+-------------------------------+------------------------------------+------------------------------+----------------------------+-------------------------------+----------------------------+ | DELETE –i *backup* | Yes | Yes | Yes | Yes | Yes | Yes | | | | | | | | | | | (see [Note1](note1)) | (see +----------------------+-------------------------------+------------------------------------+------------------------------+----------------------------+-------------------------------+----------------------------+ | DELETE –i all | Yes | Yes | Yes | Yes | Yes | Yes | +----------------------+-------------------------------+------------------------------------+------------------------------+----------------------------+-------------------------------+----------------------------+
...
[Marking the Backup Status](marking_the_backup_status) for more information.
