...
**Step 1:** Install the latest version of BART; for details, see [Using an RPM Package to Install BART](installing_bart_using_an_rpm_package).
...
\- The BART user account on the BART host. See [Configuring the BART host](configuring_the_bart_host), Step 3 for more
